...
22. Edit or remove a message you steered in while Claude works, or all of them as one, until Claude reads it. Nothing goes out while you edit. Send now stops Claude and sends one as the next turn. [Steering](https://github.com/lcestou/dsh-oh-my-claude/blob/main/docs/how-it-works.md#dsh-tools-over-mcp)
