...
- Quoted lines (`> …` at the start of a line) read as a quote in your sent messages, with a bar
  beside them like the quotes in Claude's replies and the text dimmed, and dimmed in the composer
