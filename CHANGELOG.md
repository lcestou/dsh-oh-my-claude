...
- Claude Code update settings moved out of the Tune tab into Settings, under the Claude Code updates
  ...
  which folds away. They show only while the switch is on, and with more than one box a picker
  chooses which box they apply to. The Tune tab now holds only how Claude answers.
