...
- The working line no longer shows twice for a moment when the turn's header scrolls back into
  view or the turn ends, which on a phone happened on most turns.
