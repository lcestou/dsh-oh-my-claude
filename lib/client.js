...
function PermissionChip({ sessionId, ctx }) {
  const [state, setState] = import_react3.useState(null);
  const [busy, setBusy] = import_react3.useState(false);
  const [error, setError] = import_react3.useState("");
  const isClaude = activeClaudeSession(ctx) === sessionId;
  import_react3.useEffect(() => {
  ...
  return /* @__PURE__ */ jsx_runtime2.jsxs("span", {
    ...
    children: [
      /* @__PURE__ */ jsx_runtime2.jsxs("select", {
        ...
        children: [
          /* @__PURE__ */ jsx_runtime2.jsxs("option", {
            value: "",
            children: [
              "config · ",
              state.mode
          ...
          state.modes.map((m) => /* @__PURE__ */ jsx_runtime2.jsx("option", {
            value: m,
            children: m
          }, m))
        ]
...
function TurnAccountingChip({ sessionId }) {
  ...
  return /* @__PURE__ */ jsx_runtime2.jsx("button", {
    ...
    children: /* @__PURE__ */ jsx_runtime2.jsx("span", {
      style: { color: T.muted },
      children: label
    })
  });
...
function apply(ctx) {
  ...
  ctx.slots.inject("conversation.session.header.actions", () => {
    ctx.slots.register({ name: "conversation.session.header.actions", id: "claude-permission-mode", order: 32 }, (props) => props.sessionId ? /* @__PURE__ */ jsx_runtime2.jsx(PermissionChip, {
      sessionId: props.sessionId,
      ctx
    }) : null);
    ctx.slots.register({ name: "conversation.session.header.actions", id: "claude-turn-accounting", order: 30 }, (props) => props.sessionId ? /* @__PURE__ */ jsx_runtime2.jsx(TurnAccountingChip, {
      sessionId: props.sessionId
    }) : null);
