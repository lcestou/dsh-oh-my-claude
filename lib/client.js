...
function Boxes({ boxes, setBoxes, open, onToggle }) {
  ...
  const [peers, setPeers] = import_react4.useState([]);
  const [pickedPeer, setPickedPeer] = import_react4.useState(null);
  import_react4.useEffect(() => {
    let live = true;
    fetch(`${ROUTE}/tailscale/peers`).then((r) => readJson(r)).then((b) => live && setPeers(b.peers ?? [])).catch(() => {});
    return () => {
      live = false;
    };
  }, []);
    ...
    children: [
            ...
            /* @__PURE__ */ jsx_runtime4.jsxs("div", {
              ...
              children: [
                ...
                login?.host === b.host && /* @__PURE__ */ jsx_runtime4.jsxs("div", {
                  style: { ...meta, marginTop: 6, whiteSpace: "normal" },
                  children: [
      ...
      /* @__PURE__ */ jsx_runtime4.jsxs("form", {
        ...
        children: [
          ...
          kind === "ssh" ? /* @__PURE__ */ jsx_runtime4.jsxs(jsx_runtime4.Fragment, {
            children: [
              peers.length > 0 && /* @__PURE__ */ jsx_runtime4.jsxs("select", {
                ...
                children: [
                  /* @__PURE__ */ jsx_runtime4.jsx("option", {
                    value: "",
                    children: "From Tailscale…"
                  }),
                  peers.map((p) => /* @__PURE__ */ jsx_runtime4.jsxs("option", {
                    value: p.host,
          ...
          /* @__PURE__ */ jsx_runtime4.jsx("button", {
            type: "submit",
            style: btn,
            disabled: busy || !draft.name.trim() || (kind === "ssh" ? !draft.host.trim() : !draft.url.trim()),
            children: "Add"
          })
        ]
      }),
      pickedPeer && /* @__PURE__ */ jsx_runtime4.jsx("div", {
      ...
      /* @__PURE__ */ jsx_runtime4.jsx("div", {
        style: { ...meta, whiteSpace: "normal", marginTop: 4 },
        children: kind === "ssh" ? /* @__PURE__ */ jsx_runtime4.jsx(jsx_runtime4.Fragment, {
          children: "Key-based ssh, or Tailscale SSH on a tailnet. A tailnet name, a Tailscale IP or a WireGuard address works as the host as it is. Not logged in there? The row offers a login; the panel tabs read the box the session runs on."
