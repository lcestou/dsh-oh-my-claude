...
function Runtime() {
  ...
  import_react.useEffect(() => {
    fetch(`${ROUTE}/status`).then(readJson).then(setSt).catch((e) => setError(String(e.message ?? e)));
  }, []);
  if (error)
...
function Boxes() {
  ...
  import_react.useEffect(() => {
    fetch(`${ROUTE}/boxes`).then(readJson).then((body) => {
      setBoxes(body.boxes ?? []);
          ...
          /* @__PURE__ */ jsx_runtime.jsxs("div", {
            children: [
              ...
              /* @__PURE__ */ jsx_runtime.jsx("div", {
                ...
                children: "Other machines running dsh with this plugin. Open jumps there; each box keeps its own Claude Code login and sessions."
              })
            ]
          }),
          /* @__PURE__ */ jsx_runtime.jsx("button", {
  ...
  function Section() {
    return /* @__PURE__ */ jsx_runtime.jsxs("div", {
      children: [
        ...
        /* @__PURE__ */ jsx_runtime.jsx(Boxes, {})
      ]
    });
  }
