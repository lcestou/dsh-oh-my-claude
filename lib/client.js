...
function InstructionsBody({ sessionId, ctx }) {
  ...
  const refresh = () => {
    if (!cwd)
      return;
    fetch(`${ROUTE}/instructions?${q}`).then((r) => readJson(r)).then((b) => setFiles(b.files ?? [])).catch((e) => setError(e.message));
  };
  import_react3.useEffect(() => {
    refresh();
  }, [cwd]);
...
function McpBody({ sessionId, ctx }) {
  ...
  return /* @__PURE__ */ jsx_runtime2.jsxs("div", {
    ...
    children: [
      ...
      showAdd && /* @__PURE__ */ jsx_runtime2.jsx(McpAddForm, {
        sessionId,
...
function OhMyClaudeControl({ sessionId, ctx }) {
  ...
  const [memoryCount, setMemoryCount] = import_react3.useState(null);
  const onCount = import_react3.useCallback((n) => setMemoryCount(n), []);
    ...
    children: [
      ...
      /* @__PURE__ */ jsx_runtime3.jsx("div", {
        ...
        children: rows.map((r, i) => {
          const header = box === "all" && r.g !== lastGroup ? /* @__PURE__ */ jsx_runtime3.jsxs("div", {
            style: {
              ...meta,
              display: "flex",
              gap: 8,
            ...
            children: [
              ...
              r.g.host && /* @__PURE__ */ jsx_runtime3.jsx("span", {
                style: pill(T.faint),
                children: r.g.host
              })
            ]
          ...
          return [
            ...
            lastOfGroup && more > 0 ? /* @__PURE__ */ jsx_runtime3.jsxs("div", {
...
function CostLine({ sessionId, ctx }) {
  ...
  import_react4.useEffect(() => {
    ...
    let rowLead = "";
    const tryHook = () => {
      if (inline?.isConnected || !anchorRef.current?.isConnected)
        return;
      ...
      if (statsRow.parentElement)
        rowObserver.observe(statsRow.parentElement, { childList: true });
      setHooked(true);
    };
      ...
      for (const rec of records)
        for (const node of rec.addedNodes) {
          if (!(node instanceof HTMLElement))
            continue;
          const tip = node.matches('[role="tooltip"]') ? node : node.querySelector('[role="tooltip"]') ?? node.closest('[role="tooltip"]');
          if (!tip || tip.querySelector(`:scope > [${MARK}]`) || !rowLead)
            continue;
...
function apply(ctx) {
  ...
  function Section() {
    ...
    const [openSettings, setOpenSettings] = import_react4.useState(false);
    const [error, setError] = import_react4.useState("");
    import_react4.useEffect(() => {
    ...
    return /* @__PURE__ */ jsx_runtime3.jsxs("div", {
      children: [
        ...
        /* @__PURE__ */ jsx_runtime3.jsx(SettingsEditor, {
          open: openSettings,
