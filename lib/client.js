...
var stateText = { ...meta, padding: "2px 4px", whiteSpace: "normal" };
var PANEL_ATTR = "data-omc-panel";
var DOCK_ATTR = "data-omc-dock";
var panelSurface = {
...
var PANEL_STYLE_ID = "dsh-oh-my-claude-panel";
function ensurePanelStyle() {
  ...
  const inScope = (sel) => `[${PANEL_ATTR}] ${sel}, [${DOCK_ATTR}] ${sel}`;
  el.textContent = [
    `${scope} {`,
...
var claudeMount = (provider) => provider?.startsWith("claude-code") === true ? provider : undefined;
var claudeProviderOf = (ctx, id) => {
  try {
    const live = claudeMount(ctx.modelDirectories.directoryFor(id).store.getSnapshot().current?.provider);
    if (live !== undefined)
      return live;
  } catch {}
...
var boxParam = (ctx, id) => boxQuery(ctx, id).replace("?", "&");
var isClaudeSession = (ctx, id) => claudeProviderOf(ctx, id) !== undefined;
var gone = false;
var goneWatchers = new Set;
var whenContextGone = (fn) => {
  if (gone)
    fn();
  else
    goneWatchers.add(fn);
...
var guard = (fn) => {
  return (...args) => {
    ...
    try {
      ...
      if (!(e instanceof Error) || !e.message.includes("inactive context"))
        throw e;
      retire();
    }
  };
};
var openSessionId = (ctx) => {
  if (gone)
    return;
  try {
...
// src/client/spark.tsx
var jsx_runtime = require("react/jsx-runtime");
var PATH = "m19.6 66.5 19.7-11 .3-1-.3-.5h-1l-3.3-.2-11.2-.3L14 53l-9.5-.5-2.4-.5L0 49l.2-1.5 2-1.3 2.9.2 6.3.5 9.5.6 6.9.4L38 49.1h1.6l.2-.7-.5-.4-.4-.4L29 41l-10.6-7-5.6-4.1-3-2-1.5-2-.6-4.2 2.7-3 3.7.3.9.2 3.7 2.9 8 6.1L37 36l1.5 1.2.6-.4.1-.3-.7-1.1L33 25l-6-10.4-2.7-4.3-.7-2.6c-.3-1-.4-2-.4-3l3-4.2L28 0l4.2.6L33.8 2l2.6 6 4.1 9.3L47 29.9l2 3.8 1 3.4.3 1h.7v-.5l.5-7.2 1-8.7 1-11.2.3-3.2 1.6-3.8 3-2L61 2.6l2 2.9-.3 1.8-1.1 7.7L59 27.1l-1.5 8.2h.9l1-1.1 4.1-5.4 6.9-8.6 3-3.5L77 13l2.3-1.8h4.3l3.1 4.7-1.4 4.9-4.4 5.6-3.7 4.7-5.3 7.1-3.2 5.7.3.4h.7l12-2.6 6.4-1.1 7.6-1.3 3.5 1.6.4 1.6-1.4 3.4-8.2 2-9.6 2-14.3 3.3-.2.1.2.3 6.4.6 2.8.2h6.8l12.6 1 3.3 2 1.9 2.7-.3 2-5.1 2.6-6.8-1.6-16-3.8-5.4-1.3h-.8v.4l4.6 4.5 8.3 7.5L89 80.1l.5 2.4-1.3 2-1.4-.2-9.2-7-3.6-3-8-6.8h-.5v.7l1.8 2.7 9.8 14.7.5 4.5-.7 1.4-2.6 1-2.7-.6-5.8-8-6-9-4.7-8.2-.5.4-2.9 30.2-1.3 1.5-3 1.2-2.5-2-1.4-3 1.4-6.2 1.6-8 1.3-6.4 1.2-7.9.7-2.6v-.2H49L43 72l-9 12.3-7.2 7.6-1.7.7-3-1.5.3-2.8L24 86l10-12.8 6-7.9 4-4.6-.1-.5h-.3L17.2 77.4l-4.7.6-2-2 .2-3 1-1 8-5.5Z";
function Spark({
  size = 14,
  color = CLAUDE_ORANGE
}) {
...
function sparkNode(size = 14, color = CLAUDE_ORANGE) {
...
var onBox = (provider) => provider === undefined ? "" : `?provider=${encodeURIComponent(provider)}`;
var read = (provider) => fetch(`${ROUTE}/settings${onBox(provider)}`).then((r) => readJson(r));
...
function ConfirmButton({
  ...
  const [armed, setArmed] = import_react2.useState(false);
...
function TuneBody({
  ...
  import_react2.useEffect(() => {
    let live = true;
    read(provider).then((f) => live && setFile(f), (e) => live && setError(e.message));
  ...
  if (!file)
    return error ? /* @__PURE__ */ jsx_runtime2.jsx("span", {
      style: errText,
      children: error
  ...
  const apply = async (mutate) => {
    ...
    try {
      ...
      if (next.error !== undefined)
        return next.error;
      setFile(await readJson(await fetch(`${ROUTE}/settings${onBox(provider)}`, {
        method: "PUT",
        headers: { "content-type": "application/json" },
  ...
  return /* @__PURE__ */ jsx_runtime2.jsxs("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx_runtime2.jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx_runtime2.jsx("div", {
            style: controlStyle,
            children: /* @__PURE__ */ jsx_runtime2.jsxs("select", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx_runtime2.jsx("div", {
            ...
            children: /* @__PURE__ */ jsx_runtime2.jsx("select", {
              ...
              children: THINKING_PRESETS.map((p) => /* @__PURE__ */ jsx_runtime2.jsx("option", {
          ...
          /* @__PURE__ */ jsx_runtime2.jsx("span", {
            style: sourceStyle,
            children: thinkErr ? /* @__PURE__ */ jsx_runtime2.jsx("span", {
              style: { color: T.err },
              children: thinkErr
            }) : "live · this session"
          })
            ...
            children: /* @__PURE__ */ jsx_runtime2.jsxs("select", {
              ...
              children: [
                ...
                models?.map((m) => {
                  ...
                  return /* @__PURE__ */ jsx_runtime2.jsxs("option", {
                    value: m.id,
                    disabled: blocked,
                    children: [
                      m.name,
      ...
      modelsError && /* @__PURE__ */ jsx_runtime2.jsxs("span", {
        style: errText,
        children: [
      ...
      creditsError ? /* @__PURE__ */ jsx_runtime2.jsxs("span", {
        style: { ...meta, padding: "0 6px 2px", whiteSpace: "normal" },
        children: [
      ...
      }) : extraUsage === false ? /* @__PURE__ */ jsx_runtime2.jsxs("span", {
        style: { ...meta, padding: "0 6px 2px", whiteSpace: "normal" },
        children: [
          ...
          /* @__PURE__ */ jsx_runtime2.jsx("div", {
            ...
            children: /* @__PURE__ */ jsx_runtime2.jsxs("select", {
              ...
              children: [
                ...
                models?.map((m) => /* @__PURE__ */ jsx_runtime2.jsx("option", {
                  value: m.id,
                  children: m.name
                }, m.id))
              ]
      ...
      showTrailers ? /* @__PURE__ */ jsx_runtime2.jsxs(jsx_runtime2.Fragment, {
        children: [
          [
          ...
          ].map(([key, label, hint]) => /* @__PURE__ */ jsx_runtime2.jsxs("div", {
            style: rowStyle,
            children: [
              /* @__PURE__ */ jsx_runtime2.jsx("span", {
                style: labelStyle,
              ...
              /* @__PURE__ */ jsx_runtime2.jsx("div", {
                ...
                children: /* @__PURE__ */ jsx_runtime2.jsx("input", {
                  type: "text",
      ...
      /* @__PURE__ */ jsx_runtime2.jsx(PermissionsBlock, {
        file,
        apply,
        sessionId,
...
function PermissionsBlock({
  ...
  const [others, setOthers] = import_react2.useState([]);
  ...
  import_react2.useEffect(() => {
    ...
    fetch(`${ROUTE}/settings/scopes${q ? `?${q}` : ""}`).then((r) => readJson(r)).then((body) => {
      if (live)
        setOthers((body.scopes ?? []).filter((sc) => sc.path !== file.path));
    }).catch(() => {});
    return () => {
      live = false;
    };
    ...
    children: [
      ...
      /* @__PURE__ */ jsx_runtime2.jsxs("span", {
        ...
        children: [
          ...
          " ",
          SCOPE_LABELS.user,
          ", the file this panel writes; Claude Code also reads the files below it, in dsh or in a terminal."
        ]
      }),
      error ? /* @__PURE__ */ jsx_runtime2.jsx("span", {
        style: { ...errText, display: "block" },
        children: error
      }) : null,
      PERMISSION_KINDS.filter((k) => rules[k].length > 0).map((k) => /* @__PURE__ */ jsx_runtime2.jsxs("div", {
        ...
        children: [
          ...
          rules[k].map((rule) => /* @__PURE__ */ jsx_runtime2.jsxs("div", {
            style: ruleRow,
            children: [
              /* @__PURE__ */ jsx_runtime2.jsx("span", {
              ...
              /* @__PURE__ */ jsx_runtime2.jsx(ConfirmButton, {
                label: "Remove",
      ...
      others.map((scope) => {
        ...
        return /* @__PURE__ */ jsx_runtime2.jsxs("div", {
          ...
          children: [
            /* @__PURE__ */ jsx_runtime2.jsxs("div", {
              style: { ...heading, textTransform: "none" },
              children: [
                SCOPE_LABELS[scope.scope],
                " · read-only here"
              ]
            }),
            kinds.map((k) => theirs[k].map((rule) => /* @__PURE__ */ jsx_runtime2.jsxs("div", {
              style: { ...ruleRow, color: T.muted },
              children: [
                /* @__PURE__ */ jsx_runtime2.jsx("span", {
                  style: { flex: 1, wordBreak: "break-all", fontFamily: T.mono },
                  children: rule
                ...
                /* @__PURE__ */ jsx_runtime2.jsx("span", {
                  style: { ...meta, textTransform: "capitalize" },
                  children: k
                })
              ]
            }, `${k}:${rule}`)))
      ...
      unused.length > 0 ? /* @__PURE__ */ jsx_runtime2.jsxs("div", {
        style: { marginBottom: 8 },
        children: [
          /* @__PURE__ */ jsx_runtime2.jsx("div", {
            style: heading,
          ...
          /* @__PURE__ */ jsx_runtime2.jsx("div", {
            ...
            children: unused.map((rule) => /* @__PURE__ */ jsx_runtime2.jsx("button", {
              type: "button",
              onClick: () => {
                setDraft(rule);
                setError("");
      ...
      /* @__PURE__ */ jsx_runtime2.jsxs("div", {
        ...
        children: [
          /* @__PURE__ */ jsx_runtime2.jsx("select", {
            ...
            children: PERMISSION_KINDS.map((k) => /* @__PURE__ */ jsx_runtime2.jsx("option", {
              value: k,
              children: k
            }, k))
          }),
...
function RestoreBody({
  ...
  return /* @__PURE__ */ jsx_runtime3.jsxs("div", {
    style: bodyFlow,
    children: [
      rest.map((s) => /* @__PURE__ */ jsx_runtime3.jsx(TranscriptRow, {
        s,
        cwd,
        ctx,
        onClose
      }, s.id)),
      owned.length > 0 && /* @__PURE__ */ jsx_runtime3.jsxs("span", {
...
function MemoryBody({ sessionId, ctx }) {
  ...
  const refresh = (signal) => {
    if (!cwd)
      return;
    fetch(`${ROUTE}/memory?${q}`, { signal }).then((r) => readJson(r)).then((b) => setFiles(b.files ?? [])).catch((e) => {
  ...
  import_react3.useEffect(() => {
    ...
    refresh(stop.signal);
    const timer = setInterval(() => refresh(stop.signal), 30000);
    return () => {
      clearInterval(timer);
      stop.abort();
    };
  ...
  const save = async () => {
    ...
    setError("");
    try {
      await readJson(await fetch(`${ROUTE}/memory?${q}`, {
        method: "PUT",
        headers: { "content-type": "application/json" },
  ...
  if (!cwd)
    return /* @__PURE__ */ jsx_runtime3.jsx("span", {
      style: stateText,
      children: "Open a workspace to see its memory files."
    });
  if (files.length === 0)
    return /* @__PURE__ */ jsx_runtime3.jsx("span", {
      style: stateText,
      children: "No memory files for this workspace yet. Claude writes them as it learns the project."
    });
  const dirty = text !== saved;
  return /* @__PURE__ */ jsx_runtime3.jsxs("div", {
    style: bodyFlow,
    children: [
      file === null ? files.map((f) => /* @__PURE__ */ jsx_runtime3.jsxs("button", {
        type: "button",
        style: {
          ...btn,
          display: "flex",
      ...
      }, f.name)) : /* @__PURE__ */ jsx_runtime3.jsxs(jsx_runtime3.Fragment, {
        children: [
      ...
      error && /* @__PURE__ */ jsx_runtime3.jsx("span", {
        style: errText,
        children: error
      })
    ]
  ...
  return /* @__PURE__ */ jsx_runtime3.jsxs("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx_runtime3.jsx("select", {
        ...
        children: PLUGIN_SCOPE_OPTS.map((o) => /* @__PURE__ */ jsx_runtime3.jsx("option", {
          value: o.value,
          children: o.label
        }, o.value))
      }),
...
function PluginManagerBlock({
  ...
  const act = async (path, body, id) => {
    ...
    setError("");
    try {
      const r = await readJson(await fetch(`${ROUTE}${path}${boxQuery(ctx, sessionId)}`, {
        method: "POST",
        headers: { "content-type": "application/json" },
  ...
  return /* @__PURE__ */ jsx_runtime3.jsxs(jsx_runtime3.Fragment, {
    children: [
      ...
      /* @__PURE__ */ jsx_runtime3.jsxs("div", {
        ...
        children: [
          plugins.length === 0 && marketplaces.length === 0 && /* @__PURE__ */ jsx_runtime3.jsx("span", {
            style: { ...meta, fontSize: 12 },
            children: "No settings file names a plugin (enabledPlugins) or a marketplace."
          }),
          plugins.map((p) => /* @__PURE__ */ jsx_runtime3.jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx_runtime3.jsx(ConfirmButton, {
                label: "Remove",
                style: small,
                disabled: busy !== "",
          ...
          marketplaces.map((m) => /* @__PURE__ */ jsx_runtime3.jsxs("div", {
            style: { display: "flex", gap: 8, alignItems: "center" },
            children: [
              /* @__PURE__ */ jsx_runtime3.jsx("span", {
                style: { ...meta, flex: "none" },
              ...
              /* @__PURE__ */ jsx_runtime3.jsx(ConfirmButton, {
                ...
                onAct: () => void act("/plugins/marketplace/remove", { name: m.name, scope: m.scope }, m.name)
              })
            ]
          }, m.name)),
          /* @__PURE__ */ jsx_runtime3.jsx(MarketplaceAddForm, {
            act,
            busy
          }),
          error !== "" && /* @__PURE__ */ jsx_runtime3.jsx("span", {
...
function InstructionsBody({ sessionId, ctx }) {
  ...
  const save = async () => {
    ...
    setError("");
    try {
      await readJson(await fetch(`${ROUTE}/instructions/file${onBox === "" ? "" : `?${onBox}`}`, {
        method: "PUT",
        headers: { "content-type": "application/json" },
  ...
  return /* @__PURE__ */ jsx_runtime3.jsxs("div", {
    style: bodyFlow,
    children: [
      file === null && files.length === 0 && /* @__PURE__ */ jsx_runtime3.jsx("span", {
      ...
      file === null ? files.map((f) => /* @__PURE__ */ jsx_runtime3.jsxs("button", {
        ...
        children: [
          ...
          f.importedBy && /* @__PURE__ */ jsx_runtime3.jsxs("span", {
            style: { ...meta, flex: "none", marginLeft: 8 },
            children: [
              "(from ",
      ...
      }, f.path)) : /* @__PURE__ */ jsx_runtime3.jsxs(jsx_runtime3.Fragment, {
        children: [
          /* @__PURE__ */ jsx_runtime3.jsxs("div", {
            style: { display: "flex", alignItems: "center", gap: 8 },
            children: [
              ...
              file.kind === "Managed" && /* @__PURE__ */ jsx_runtime3.jsx("span", {
                style: { ...meta, flex: "none" },
                children: "read-only (managed)"
              }),
              file.kind !== "Managed" && /* @__PURE__ */ jsx_runtime3.jsx("button", {
                type: "button",
                style: dirty ? btnPrimary : btn,
                onClick: save,
                disabled: busy || !dirty,
      ...
      file === null && /* @__PURE__ */ jsx_runtime3.jsx(PluginManagerBlock, {
        roster,
        sessionId,
        ctx,
...
function RewindBody({
  ...
  import_react3.useEffect(() => {
    ...
    setPreview(null);
    setError("");
    fetch(`${ROUTE}/rewind?session=${encodeURIComponent(sessionId)}&cwd=${encodeURIComponent(cwd)}${boxParam(ctx, sessionId)}`).then((r) => readJson(r)).then((b) => live && setPrompts(b.prompts ?? [])).catch((e) => live && setError(e.message));
    return () => {
      live = false;
    };
  }, [cwd, sessionId]);
  ...
  return /* @__PURE__ */ jsx_runtime3.jsxs("div", {
    style: bodyFlow,
    children: [
      noFiles && /* @__PURE__ */ jsx_runtime3.jsx("span", {
        style: errText,
      ...
      picked === null ? prompts.length === 0 ? /* @__PURE__ */ jsx_runtime3.jsx("span", {
        style: { ...meta, padding: "2px 4px" },
        children: "No completed prompts yet"
      }) : prompts.map((p) => /* @__PURE__ */ jsx_runtime3.jsxs("button", {
        type: "button",
        style: {
          ...btn,
          display: "flex",
      ...
      }, p.id)) : /* @__PURE__ */ jsx_runtime3.jsxs(jsx_runtime3.Fragment, {
        children: [
          /* @__PURE__ */ jsx_runtime3.jsxs("span", {
      ...
      picked === null && prompts.length > 0 && /* @__PURE__ */ jsx_runtime3.jsxs("span", {
        style: { ...meta, padding: "2px 4px", whiteSpace: "normal" },
        children: [
...
function ChangesBody({ sessionId, ctx }) {
  ...
  return /* @__PURE__ */ jsx_runtime3.jsx("div", {
    style: bodyFlow,
    children: reply === null ? /* @__PURE__ */ jsx_runtime3.jsx("span", {
      style: stateText,
      children: "Loading…"
    }) : !reply.ok ? /* @__PURE__ */ jsx_runtime3.jsx("span", {
      style: errText,
      children: reply.error
    }) : current ? /* @__PURE__ */ jsx_runtime3.jsxs(jsx_runtime3.Fragment, {
      children: [
        /* @__PURE__ */ jsx_runtime3.jsxs("div", {
        ...
        current.hunks.length === 0 ? /* @__PURE__ */ jsx_runtime3.jsx("span", {
          style: { ...meta, padding: "2px 4px" },
          children: current.binary ? "Binary file" : current.untracked ? "Untracked file" : "No hunks"
        }) : current.hunks.map((h, i) => /* @__PURE__ */ jsx_runtime3.jsxs("pre", {
          style: {
            margin: "2px 4px",
            padding: 6,
            fontSize: 12,
...
`
            ...
            h.lines.map((l, j) => /* @__PURE__ */ jsx_runtime3.jsxs("span", {
              style: {
...
`
      ...
      children: [
        ...
        files.map((f) => /* @__PURE__ */ jsx_runtime3.jsxs("button", {
          type: "button",
          style: {
            ...btn,
            display: "flex",
...
function McpBody({ sessionId, ctx }) {
  ...
  const remove = async (serverName) => {
    ...
    setNote("");
    try {
      const r = await readJson(await fetch(`${ROUTE}/mcp-servers/remove${boxQuery(ctx, sessionId)}`, {
        method: "POST",
        headers: { "content-type": "application/json" },
        body: JSON.stringify({ session: sessionId, name: serverName })
      }));
    ...
    children: [
      ...
      /* @__PURE__ */ jsx_runtime3.jsx("div", {
        ...
        children: /* @__PURE__ */ jsx_runtime3.jsx("div", {
          ...
          children: /* @__PURE__ */ jsx_runtime3.jsx(McpAddForm, {
            sessionId,
            ctx,
      ...
      reply === null ? /* @__PURE__ */ jsx_runtime3.jsx("span", {
        style: stateText,
        children: "Loading…"
      }) : !reply.ok ? /* @__PURE__ */ jsx_runtime3.jsx("span", {
        style: errText,
        children: reply.error
      }) : servers.length === 0 ? /* @__PURE__ */ jsx_runtime3.jsx("span", {
        style: { ...meta, padding: "2px 4px" },
        children: "No MCP servers"
      }) : servers.map((s) => /* @__PURE__ */ jsx_runtime3.jsxs("div", {
        children: [
          /* @__PURE__ */ jsx_runtime3.jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx_runtime3.jsxs("span", {
                ...
                children: [
                  s.name,
                  s.version ? /* @__PURE__ */ jsx_runtime3.jsxs("span", {
                    style: meta,
                    children: [
                      " ",
                      s.version
              ...
              s.status !== "needs-auth" && /* @__PURE__ */ jsx_runtime3.jsx("button", {
                type: "button",
                style: btn,
                disabled: busy !== null,
          ...
          s.status !== "connected" && (s.error || s.status === "needs-auth") ? /* @__PURE__ */ jsx_runtime3.jsx("div", {
          ...
          s.tools && s.tools.length > 0 ? /* @__PURE__ */ jsx_runtime3.jsx("div", {
            style: { padding: "0 6px 4px 22px", color: T.muted, fontSize: 12 },
            children: s.tools.join(" · ")
          }) : null
        ]
      }, s.name)),
      note && /* @__PURE__ */ jsx_runtime3.jsx("span", {
...
function DiagnosticsBody({ sessionId, ctx }) {
  ...
  import_react3.useEffect(() => {
    ...
    fetch(`${ROUTE}/diagnostics?cwd=${encodeURIComponent(cwd)}${on}`).then((r) => readJson(r)).then((b) => live && setData(b)).catch((e) => live && setData({ ok: false, error: e.message }));
    return () => {
      live = false;
    };
  }, [cwd, ctx, sessionId]);
  ...
  const runDoctor = async () => {
    ...
    setDoctorError("");
    try {
      const r = await readJson(await fetch(`${ROUTE}/diagnostics/doctor${doctorQuery}`, { method: "POST" }));
      if (r.error) {
  ...
  return /* @__PURE__ */ jsx_runtime3.jsx("div", {
    style: bodyFlow,
    children: data === null ? /* @__PURE__ */ jsx_runtime3.jsx("span", {
      style: stateText,
      children: "Loading…"
    }) : !data.ok ? /* @__PURE__ */ jsx_runtime3.jsx("span", {
      style: errText,
      ...
      children: [
          ...
          children: [
            ...
            /* @__PURE__ */ jsx_runtime3.jsxs("div", {
              children: [
                "Login:",
                " ",
                data.runtime.loggedIn ? /* @__PURE__ */ jsx_runtime3.jsxs("span", {
                  style: { color: T.ok },
                  children: [
            ...
            data.runtime.error && /* @__PURE__ */ jsx_runtime3.jsx("div", {
              style: { color: T.err },
        ...
        data.configFiles.length === 0 ? /* @__PURE__ */ jsx_runtime3.jsx("span", {
          style: { ...meta, padding: "2px 4px", fontSize: 12 },
          children: "No config files"
        }) : data.configFiles.map((f) => /* @__PURE__ */ jsx_runtime3.jsxs("div", {
          style: {
            padding: "4px 10px",
            fontSize: 12,
          ...
          children: [
            ...
            !f.exists && /* @__PURE__ */ jsx_runtime3.jsx("div", {
              style: { ...meta, fontSize: 11 },
              children: "not found"
            }),
            f.parseError && /* @__PURE__ */ jsx_runtime3.jsx("div", {
              style: { fontSize: 11 },
              children: f.parseError
            })
          ]
        }, f.scope)),
        /* @__PURE__ */ jsx_runtime3.jsx(SessionNotices, {}),
        /* @__PURE__ */ jsx_runtime3.jsx("span", {
          style: { ...meta, padding: "2px 4px", display: "block", marginTop: 8 },
          children: "Feature switches"
        }),
        switches === null ? /* @__PURE__ */ jsx_runtime3.jsx("span", {
          style: stateText,
          children: "Loading…"
        }) : /* @__PURE__ */ jsx_runtime3.jsxs("div", {
          style: { padding: "4px 10px", fontSize: 12, lineHeight: "1.5" },
        ...
        !running ? /* @__PURE__ */ jsx_runtime3.jsx("span", {
          style: { ...meta, padding: "2px 4px", fontSize: 12 },
          children: "Claude is not running for this session."
        }) : mcp === null ? /* @__PURE__ */ jsx_runtime3.jsx("span", {
          style: stateText,
          children: "Loading…"
        }) : !mcp.ok ? /* @__PURE__ */ jsx_runtime3.jsx("span", {
          style: errText,
          children: mcp.error
        }) : mcp.servers.every((s) => s.status === "connected") ? /* @__PURE__ */ jsx_runtime3.jsx("span", {
          style: { ...meta, padding: "2px 4px", fontSize: 12 },
          children: mcp.servers.length === 0 ? "No MCP servers" : "All connected"
        }) : mcp.servers.filter((s) => s.status !== "connected").map((s) => /* @__PURE__ */ jsx_runtime3.jsxs("div", {
          style: {
            display: "flex",
            alignItems: "baseline",
            gap: 8,
          ...
          children: [
            /* @__PURE__ */ jsx_runtime3.jsxs("span", {
              ...
              children: [
                ...
                s.error && /* @__PURE__ */ jsx_runtime3.jsx("div", {
        ...
        auditError ? /* @__PURE__ */ jsx_runtime3.jsx("span", {
          style: errText,
          children: auditError
        }) : audit === null ? /* @__PURE__ */ jsx_runtime3.jsx("span", {
          style: stateText,
          children: "Loading…"
        }) : audit.length === 0 ? /* @__PURE__ */ jsx_runtime3.jsx("span", {
          style: { ...meta, padding: "2px 4px", fontSize: 12 },
          children: "No calls were refused in the turns kept for this session."
        }) : audit.map((t) => /* @__PURE__ */ jsx_runtime3.jsxs("div", {
          ...
          children: [
            ...
            t.denials?.map((label) => /* @__PURE__ */ jsx_runtime3.jsx("div", {
        ...
        /* @__PURE__ */ jsx_runtime3.jsxs("div", {
          ...
          children: [
            ...
            doctorError && /* @__PURE__ */ jsx_runtime3.jsx("div", {
              style: { color: T.err, fontSize: 12, marginTop: 4 },
              children: doctorError
            }),
            doctorOutput && /* @__PURE__ */ jsx_runtime3.jsx("pre", {
              style: {
                marginTop: 6,
                padding: 8,
                fontSize: 11,
...
function TaskRow({ task }) {
  return /* @__PURE__ */ jsx_runtime3.jsxs("div", {
    ...
    children: [
      ...
      task.description ? /* @__PURE__ */ jsx_runtime3.jsx("div", {
        style: { ...meta, fontSize: 11 },
        children: task.description
      }) : null,
      task.schedule ? /* @__PURE__ */ jsx_runtime3.jsxs("div", {
        style: { ...meta, fontSize: 11 },
        children: [
          "Schedule: ",
          task.schedule
      ...
      task.nextRunAt === undefined ? null : /* @__PURE__ */ jsx_runtime3.jsxs("div", {
        style: { ...meta, fontSize: 11 },
        children: [
          "Next run: ",
...
function TasksBody({ sessionId, ctx }) {
  ...
  import_react3.useEffect(() => {
    if (!running)
      return;
    let live = true;
    fetch(`${ROUTE}/scheduled-tasks?session=${encodeURIComponent(sessionId)}${boxParam(ctx, sessionId)}`).then((r) => readJson(r)).then((b) => live && setData(b)).catch((e) => live && setData({ ok: false, error: e.message }));
    return () => {
      live = false;
    };
  }, [running, sessionId]);
  ...
  return /* @__PURE__ */ jsx_runtime3.jsx("div", {
    ...
    children: data === null ? /* @__PURE__ */ jsx_runtime3.jsx("span", {
      ...
      children: [
        ...
        data.goal ? /* @__PURE__ */ jsx_runtime3.jsxs("div", {
          style: { padding: "4px 10px", fontSize: 12, lineHeight: "1.5" },
          children: [
            /* @__PURE__ */ jsx_runtime3.jsx("div", {
        ...
        data.durable.length === 0 ? /* @__PURE__ */ jsx_runtime3.jsxs("div", {
          style: { ...meta, padding: "4px 10px", fontSize: 12 },
          children: [
            /* @__PURE__ */ jsx_runtime3.jsx("div", {
        ...
        }) : data.durable.map((t) => /* @__PURE__ */ jsx_runtime3.jsx(TaskRow, {
          task: t
        }, t.name)),
        data.session.length > 0 ? /* @__PURE__ */ jsx_runtime3.jsxs(jsx_runtime3.Fragment, {
          children: [
            /* @__PURE__ */ jsx_runtime3.jsx("span", {
              style: { ...meta, padding: "2px 4px", display: "block", marginTop: 8 },
              children: "Session-only, reconstructed from this session's transcript; these die when Claude exits."
            }),
            data.session.map((t) => /* @__PURE__ */ jsx_runtime3.jsx(TaskRow, {
              task: t
            }, t.name))
          ]
        }) : null,
...
function McpAddForm({
  ...
  const submit = async () => {
    ...
    setError("");
    try {
      const r = await readJson(await fetch(`${ROUTE}/mcp-servers/add${boxQuery(ctx, sessionId)}`, {
        method: "POST",
        headers: { "content-type": "application/json" },
        body: JSON.stringify({
          session: sessionId,
    ...
    children: [
      /* @__PURE__ */ jsx_runtime3.jsxs("select", {
        ...
        children: [
          ...
          CONNECTORS.map((c) => /* @__PURE__ */ jsx_runtime3.jsx("option", {
            value: c.name,
            children: c.label
          }, c.name))
        ]
      ...
      transport === "stdio" ? /* @__PURE__ */ jsx_runtime3.jsxs(jsx_runtime3.Fragment, {
        children: [
          /* @__PURE__ */ jsx_runtime3.jsx("input", {
            type: "text",
    ...
    const start = (trigger) => {
      ...
      const menuObserver = new MutationObserver(() => {
        ...
        for (const dshMenu of menus) {
          if (dshMenu.querySelector("[data-mode]"))
            continue;
...
function AsidesBody({ sessionId }) {
  const [items, setItems] = import_react3.useState(null);
  const [error, setError] = import_react3.useState(null);
  import_react3.useEffect(() => {
    let live = true;
    fetch(`${ROUTE}/side-questions?session=${encodeURIComponent(sessionId)}`).then((r) => readJson(r)).then((b) => {
      if (!live)
        return;
      if ("error" in b)
        setError(b.error);
  ...
  if (items.length === 0) {
    return /* @__PURE__ */ jsx_runtime3.jsxs("div", {
      style: { ...meta, padding: "4px 10px", fontSize: 12, whiteSpace: "normal" },
      children: [
        "No asides in this session. Ask one with ",
  ...
  return /* @__PURE__ */ jsx_runtime3.jsx("div", {
    style: bodyFlow,
    children: items.toReversed().map((it, i) => /* @__PURE__ */ jsx_runtime3.jsxs("details", {
      open: i === 0,
      style: { padding: "4px 10px", fontSize: 12, lineHeight: "1.5" },
      children: [
        /* @__PURE__ */ jsx_runtime3.jsxs("summary", {
          style: {
            cursor: "pointer",
            color: T.text,
            whiteSpace: "nowrap",
          ...
          children: [
            it.question,
            /* @__PURE__ */ jsx_runtime3.jsxs("span", {
              style: { ...meta, fontSize: 11, marginLeft: 6 },
              children: [
                ago(it.at),
        ...
        /* @__PURE__ */ jsx_runtime3.jsx("div", {
          ...
          children: it.pending ? "Waiting for an answer…" : it.answer ?? it.error ?? ""
        })
      ]
    }, it.id))
  });
  ...
  return /* @__PURE__ */ jsx_runtime3.jsxs("span", {
    ...
    children: [
      /* @__PURE__ */ jsx_runtime3.jsx("button", {
        ...
        children: /* @__PURE__ */ jsx_runtime3.jsx(Spark, {
          size: 15
        })
      }),
      open && /* @__PURE__ */ jsx_runtime3.jsxs("div", {
        role: "dialog",
        "aria-label": "Oh My Claude",
        ...{ [PANEL_ATTR]: "1" },
        style: panelStyle,
        children: [
          /* @__PURE__ */ jsx_runtime3.jsxs("div", {
            ...
            children: [
              tab === "Restore" && /* @__PURE__ */ jsx_runtime3.jsx(RestoreBody, {
                sessionId,
                ctx,
                onClose: close
              }),
              tab === "Memory" && /* @__PURE__ */ jsx_runtime3.jsx(MemoryBody, {
                sessionId,
                ctx
              }),
              tab === "Instructions" && /* @__PURE__ */ jsx_runtime3.jsx(InstructionsBody, {
                sessionId,
                ctx
              }),
              tab === "Rewind" && /* @__PURE__ */ jsx_runtime3.jsx(RewindBody, {
                sessionId,
                ctx,
                onClose: close
              }),
              tab === "Changes" && /* @__PURE__ */ jsx_runtime3.jsx(ChangesBody, {
                sessionId,
                ctx
              }),
              tab === "MCP" && /* @__PURE__ */ jsx_runtime3.jsx(McpBody, {
                sessionId,
                ctx,
                onClose: close
              }),
              tab === "Asides" && /* @__PURE__ */ jsx_runtime3.jsx(AsidesBody, {
                sessionId
              }),
              tab === "Diagnostics" && /* @__PURE__ */ jsx_runtime3.jsx(DiagnosticsBody, {
                sessionId,
                ctx
              }),
              tab === "Tasks" && /* @__PURE__ */ jsx_runtime3.jsx(TasksBody, {
                sessionId,
                ctx
              }),
              tab === "Tune" && /* @__PURE__ */ jsx_runtime3.jsx(TuneBody, {
                sessionId,
                ctx
              })
            ]
          ...
          /* @__PURE__ */ jsx_runtime3.jsx("div", {
            ...
            children: tabs.map((t) => /* @__PURE__ */ jsx_runtime3.jsx("button", {
              role: "tab",
...
var uiWorkspaceOf = (ctx) => ctx.get?.("uiWorkspace");
var localeOf = (ctx) => ctx.get?.("locale");
var canBrowseDirs = (ctx) => uiWorkspaceOf(ctx) !== undefined;
var segments = (p) => p.split("/").filter(Boolean);
function crumbsOf(path, home, homeLabel) {
  const under = home !== "" && (path === home || path.startsWith(`${home}/`));
  const root = under ? { label: homeLabel, path: home } : { label: "/", path: "/" };
...
var baseName = (path) => segments(path).at(-1) ?? "";
var OPEN_EVENT = "omc-add-workspace";
var DIALOG_CLASS = "omc-add-workspace";
var DIALOG_CSS = `.${DIALOG_CLASS}{width:min(620px,92vw);max-width:none}`;
var rowStyle = (on) => ({
  display: "flex",
  alignItems: "center",
  gap: 10,
...
var copyOf = (ctx) => {
  ...
  return (key) => (t ? t(key) : undefined) || DIALOG_EN[key] || key;
};
var level = async (ctx, host, path, signal) => {
  if (host === "") {
    const l = await uiWorkspaceOf(ctx)?.listDirectory(path === "" ? undefined : path, signal);
    if (!l)
      throw new Error("dsh's directory listing is not available");
    return { path: l.path, home: l.home, entries: l.entries };
  }
  const r = await fetch(`${ROUTE}/box-dirs?host=${encodeURIComponent(host)}&path=${encodeURIComponent(path)}`, { signal });
  return await readJson(r);
};
function AddWorkspaceFlow({ ctx }) {
  const [ssh, setSsh] = import_react4.useState([]);
  const [open, setOpen] = import_react4.useState(false);
  const [host, setHost] = import_react4.useState("");
  const [path, setPath] = import_react4.useState("");
  const [listing, setListing] = import_react4.useState(null);
  const [picked, setPicked] = import_react4.useState("");
  const [hidden, setHidden] = import_react4.useState(false);
  const [busy, setBusy] = import_react4.useState(false);
  const [error, setError] = import_react4.useState("");
  const [folder, setFolder] = import_react4.useState(null);
  const [tick, setTick] = import_react4.useState(0);
  const t = copyOf(ctx);
  import_react4.useEffect(() => {
    fetch(`${ROUTE}/ssh-boxes`).then((r) => readJson(r)).then((b) => setSsh(b.boxes ?? [])).catch(() => {});
  }, []);
  import_react4.useEffect(() => {
    if (ssh.length === 0 || !uiWorkspaceOf(ctx))
      return;
    ...
    const onClick = (e) => {
      ...
      if (!target?.closest(`button[aria-label="${CSS.escape(label)}"]`))
        return;
      e.preventDefault();
      e.stopPropagation();
      start();
  ...
  import_react4.useEffect(() => {
    ...
    setError("");
    setListing(null);
    level(ctx, host, path, ac.signal).then((l) => {
      setListing(l);
      setPicked("");
    }).catch((e) => {
  ...
  const add = () => {
    ...
    }).then((r) => readJson(r)).then(done).catch(failed);
  };
  const create = () => {
    ...
    setBusy(true);
    setError("");
    const made = host === "" ? uiWorkspaceOf(ctx)?.createDirectory(listing.path, name) ?? Promise.reject(new Error("dsh's directory listing is not available")) : fetch(`${ROUTE}/box-dirs?host=${encodeURIComponent(host)}`, {
      method: "POST",
      headers: { "content-type": "application/json" },
      body: JSON.stringify({ path: listing.path, name })
    }).then((r) => readJson(r)).then((b) => b.path);
    made.then((created) => {
      setFolder(null);
      setBusy(false);
      setTick((n) => n + 1);
  ...
  const boxes = [{ name: "This PC", host: "" }, ...ssh];
  return /* @__PURE__ */ jsx_runtime4.jsx(import_dsh_client_ui_primitives.Modal, {
    open,
    onClose: () => setOpen(false),
    className: DIALOG_CLASS,
    title: t("browser.title"),
    closeLabel: t("close"),
    footer: /* @__PURE__ */ jsx_runtime4.jsxs("div", {
      style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" },
      children: [
        /* @__PURE__ */ jsx_runtime4.jsx("select", {
          style: { ...select, maxWidth: 180 },
          value: host,
          disabled: busy,
          "aria-label": "Box",
          onChange: (e) => {
          ...
          children: boxes.map((b) => /* @__PURE__ */ jsx_runtime4.jsx("option", {
            value: b.host,
            children: b.name
          }, b.host))
        }),
        /* @__PURE__ */ jsx_runtime4.jsx(import_dsh_client_ui_primitives.Button, {
          size: "sm",
          icon: /* @__PURE__ */ jsx_runtime4.jsx(import_dsh_client_ui_primitives.IconPlusOutline16, {
            size: 16
          }),
        ...
        /* @__PURE__ */ jsx_runtime4.jsxs("label", {
    ...
    children: /* @__PURE__ */ jsx_runtime4.jsxs("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx_runtime4.jsx("div", {
          ...
          children: crumbs.map((c, i) => /* @__PURE__ */ jsx_runtime4.jsxs("span", {
            style: { display: "flex", alignItems: "center", gap: 2 },
            children: [
              i > 0 && /* @__PURE__ */ jsx_runtime4.jsx(import_dsh_client_ui_primitives.IconChevronRightOutline14, {
                size: 14
              }),
        ...
        folder !== null && /* @__PURE__ */ jsx_runtime4.jsxs("form", {
        ...
        /* @__PURE__ */ jsx_runtime4.jsxs("div", {
          ...
          children: [
            listing === null && error === "" && /* @__PURE__ */ jsx_runtime4.jsx("p", {
              style: stateText,
              children: t("browser.loading")
            }),
            listing !== null && rows.length === 0 && /* @__PURE__ */ jsx_runtime4.jsx("p", {
              style: stateText,
              children: "No folders here."
            }),
            rows.map((e) => /* @__PURE__ */ jsx_runtime4.jsxs("button", {
              type: "button",
              style: rowStyle(e.path === picked),
              onClick: () => setPicked(e.path),
              onDoubleClick: () => setPath(e.path),
              children: [
                /* @__PURE__ */ jsx_runtime4.jsx(import_dsh_client_ui_primitives.IconFolderClose16, {
                  size: 16
                }),
                /* @__PURE__ */ jsx_runtime4.jsx("span", {
                ...
                /* @__PURE__ */ jsx_runtime4.jsx("span", {
                  ...
                  children: /* @__PURE__ */ jsx_runtime4.jsx(import_dsh_client_ui_primitives.IconChevronRightOutline14, {
                    size: 14
                  })
                })
              ]
        ...
        /* @__PURE__ */ jsx_runtime4.jsx("p", {
          style: { ...stateText, fontFamily: T.mono, fontSize: 11 },
          children: target
        }),
...
var rowKey = (r) => `${r.g.key}-${r.s.id}`;
var slugFile = (title) => title.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "").slice(0, 40) || "claude";
...
function Chevron({ open }) {
  return /* @__PURE__ */ jsx_runtime5.jsx("span", {
    ...
    "aria-hidden": "true",
    children: /* @__PURE__ */ jsx_runtime5.jsx("svg", {
      width: "14",
      height: "14",
      viewBox: "0 0 14 14",
      fill: "none",
      children: /* @__PURE__ */ jsx_runtime5.jsx("polyline", {
      ...
      /* @__PURE__ */ jsx_runtime5.jsxs("div", {
        ...
        children: [
          /* @__PURE__ */ jsx_runtime5.jsxs("button", {
            ...
            children: [
              /* @__PURE__ */ jsx_runtime5.jsx(Chevron, {
                open
              }),
              ...
              summary && /* @__PURE__ */ jsx_runtime5.jsx("span", {
                style: { ...meta, whiteSpace: "normal", overflow: "hidden" },
                children: summary
              })
            ]
          }),
          actions && /* @__PURE__ */ jsx_runtime5.jsx("div", {
            style: { display: "flex", gap: 8 },
            children: actions
          })
        ]
      }),
      open && /* @__PURE__ */ jsx_runtime5.jsx("div", {
        style: { marginTop: 10 },
        children
      })
    ]
...
function Sessions({ ctx, boxes, close }) {
  const [local, setLocal] = import_react5.useState(null);
  const [remote, setRemote] = import_react5.useState([]);
  const [ssh, setSsh] = import_react5.useState([]);
  const [loading, setLoading] = import_react5.useState(true);
  const [remoteLoading, setRemoteLoading] = import_react5.useState(false);
  const [error, setError] = import_react5.useState("");
  const [box, setBox] = import_react5.useState("all");
  const [cwd, setCwd] = import_react5.useState("all");
  const [origin, setOrigin] = import_react5.useState("all");
  const [busyId, setBusyId] = import_react5.useState("");
  const [shown, setShown] = import_react5.useState({});
  const [picked, setPicked] = import_react5.useState(new Set);
  const [moving, setMoving] = import_react5.useState("");
  const fileInput = import_react5.useRef(null);
  const load = () => {
    setLoading(true);
    setError("");
    ...
    fetch(`${ROUTE}/boxes/ssh-sessions`).then((r) => readJson(r)).then((body) => setSsh(body?.boxes ?? [])).catch(() => setSsh([]));
    if (boxes.length === 0)
      return;
  ...
  import_react5.useEffect(load, [boxes.map((b) => b.url).join("|")]);
  const groups = import_react5.useMemo(() => {
    const out = [];
    if (local)
      out.push({
        key: "local",
  ...
  const paged = import_react5.useMemo(() => pageSessions(groups, { box, cwd, origin, shown }), [groups, box, cwd, origin, shown]);
  const rows = paged.list;
  const cwds = import_react5.useMemo(() => {
    const set = new Set;
  ...
  const open = async (r) => {
    if (r.g.sshBox) {
      ...
      try {
        ...
        if (model && dir.select)
          await dir.select({ provider, model });
    ...
    try {
      for (const r of wanted) {
        ...
        if (r.s.cwd)
          q.set("cwd", r.s.cwd);
        if (r.g.provider)
          q.set("provider", r.g.provider);
        const reply = await fetch(`${ROUTE}/transcript?${q.toString()}`);
        if (!reply.ok)
          throw new Error(`${r.s.id.slice(0, 8)}: ${reply.status}`);
  ...
  const importFiles = async (files) => {
    ...
    try {
      for (const f of Array.from(files)) {
        const body = await readJson(await fetch(`${ROUTE}/import`, {
          method: "POST",
          headers: { "content-type": "application/json" },
          body: JSON.stringify({ text: await f.text() })
        }));
        if (!body.id)
          throw new Error(`${f.name}: ${body.error ?? "import failed"}`);
      }
      load();
    } catch (e) {
      setError(e instanceof Error ? e.message : String(e));
  ...
  return /* @__PURE__ */ jsx_runtime5.jsxs("div", {
    children: [
      /* @__PURE__ */ jsx_runtime5.jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx_runtime5.jsxs("div", {
            ...
            children: [
              moving && /* @__PURE__ */ jsx_runtime5.jsx("span", {
                style: meta,
                children: moving
              }),
              picked.size > 0 && /* @__PURE__ */ jsx_runtime5.jsxs("button", {
        ...
        children: [
          /* @__PURE__ */ jsx_runtime5.jsxs("select", {
            ...
            children: [
              ...
              groups.map((g) => /* @__PURE__ */ jsx_runtime5.jsxs("option", {
                value: g.key,
                disabled: !g.ok,
          ...
          /* @__PURE__ */ jsx_runtime5.jsxs("select", {
            ...
            children: [
              ...
              cwds.map((c) => /* @__PURE__ */ jsx_runtime5.jsx("option", {
                value: c,
                title: c,
      ...
      error && /* @__PURE__ */ jsx_runtime5.jsx("p", {
        id: "dsh-oh-my-claude-error",
        style: { color: T.err, fontSize: 13, margin: "8px 0 0" },
        children: error
      }),
      !loading && rows.length === 0 && /* @__PURE__ */ jsx_runtime5.jsx("p", {
      ...
      /* @__PURE__ */ jsx_runtime5.jsxs("div", {
        ...
        children: [
          rows.map((r) => {
            ...
            const opened = (isLocal || isSsh) && Boolean(known[r.s.dsh?.id ?? r.s.id]) && !r.s.dsh?.archived;
            const busy = busyId === r.s.id;
            const label = busy ? "Opening…" : !isLocal && !isSsh ? `Open on ${r.g.name}` : opened ? "Show" : r.s.dsh?.archived ? "Restore" : "Open";
            return /* @__PURE__ */ jsx_runtime5.jsxs("div", {
                ...
                /* @__PURE__ */ jsx_runtime5.jsxs("div", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx_runtime5.jsxs("div", {
                      ...
                      children: [
                        multiBox && /* @__PURE__ */ jsx_runtime5.jsx("span", {
                          style: pill(T.faint),
                          title: r.g.host,
                          children: r.g.host ?? r.g.name
                        }),
                        /* @__PURE__ */ jsx_runtime5.jsx(Origin, {
                          s: r.s
                        }),
                        r.s.cwd && /* @__PURE__ */ jsx_runtime5.jsx("span", {
                          title: r.s.cwd,
                          style: {
                            fontFamily: T.mono,
                            minWidth: 0,
          ...
          more > 0 && /* @__PURE__ */ jsx_runtime5.jsxs("div", {
            ...
            children: [
              ...
              grown && /* @__PURE__ */ jsx_runtime5.jsxs("button", {
                type: "button",
                style: btn,
...
function SettingsEditor({ open, onToggle, box, ctx }) {
  const [scope, setScope] = import_react5.useState("user");
  const [cwd, setCwd] = import_react5.useState(null);
  const [scopes, setScopes] = import_react5.useState([]);
  const [file, setFile] = import_react5.useState(null);
  ...
  const [error, setError] = import_react5.useState("");
  const [saved, setSaved] = import_react5.useState("");
  ...
  import_react5.useEffect(load, [settingsUrl, scopesUrl, scope]);
  const parsed = import_react5.useMemo(() => {
    try {
      const value = JSON.parse(text);
      if (!isObj(value))
        return { error: "settings.json must be a JSON object" };
  ...
  const actions = editing ? /* @__PURE__ */ jsx_runtime5.jsxs(jsx_runtime5.Fragment, {
    children: [
      /* @__PURE__ */ jsx_runtime5.jsx("button", {
  ...
  }) : open ? /* @__PURE__ */ jsx_runtime5.jsxs(jsx_runtime5.Fragment, {
    children: [
      /* @__PURE__ */ jsx_runtime5.jsx("button", {
        type: "button",
        style: btn,
  ...
  return /* @__PURE__ */ jsx_runtime5.jsxs(Card, {
    ...
    children: [
      ...
      !box && /* @__PURE__ */ jsx_runtime5.jsxs(jsx_runtime5.Fragment, {
        children: [
          /* @__PURE__ */ jsx_runtime5.jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx_runtime5.jsx("select", {
                ...
                children: SETTINGS_SCOPES.toReversed().map((s) => /* @__PURE__ */ jsx_runtime5.jsx("option", {
                  value: s,
                  disabled: cwdOptions.length === 0 && (s === "project" || s === "local"),
                  children: s
                }, s))
              }),
              (scope === "project" || scope === "local") && (cwdOptions.length > 0 ? /* @__PURE__ */ jsx_runtime5.jsx("select", {
                value: projectCwd ?? "",
                onChange: (e) => setCwd(e.target.value),
                disabled: busy || editing,
                style: { ...inputStyle, padding: "4px 6px", fontSize: 12, flex: 1 },
                children: cwdOptions.map((c) => /* @__PURE__ */ jsx_runtime5.jsx("option", {
                  value: c,
                  children: c
                }, c))
              }) : /* @__PURE__ */ jsx_runtime5.jsx("span", {
          ...
          (readOnly || override) && /* @__PURE__ */ jsx_runtime5.jsxs("div", {
      ...
      editing ? /* @__PURE__ */ jsx_runtime5.jsx("textarea", {
      ...
      /* @__PURE__ */ jsx_runtime5.jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx_runtime5.jsx("span", {
            ...
            children: error ? /* @__PURE__ */ jsx_runtime5.jsx("span", {
              style: { color: T.err },
              children: error
...
function Boxes({ ctx, boxes, setBoxes, open, onToggle }) {
  const [probe, setProbe] = import_react5.useState({});
  const [self, setSelf] = import_react5.useState(null);
  const [ssh, setSsh] = import_react5.useState([]);
  const [sshProbe, setSshProbe] = import_react5.useState({});
  const [kind, setKind] = import_react5.useState("ssh");
  const canAdd = ssh.length > 0 && canBrowseDirs(ctx);
  const [draft, setDraft] = import_react5.useState({ name: "", url: "", token: "", host: "" });
  const [ts, setTs] = import_react5.useState(null);
  const [wg, setWg] = import_react5.useState(null);
  const [pickedPeer, setPickedPeer] = import_react5.useState(null);
  const [tsLogin, setTsLogin] = import_react5.useState(null);
  const [tsServer, setTsServer] = import_react5.useState({ loginServer: "", authKey: "" });
  const loadNets = import_react5.useCallback(() => {
    fetch(`${ROUTE}/tailscale/status`).then((r) => readJson(r)).then(setTs).catch(() => {});
    fetch(`${ROUTE}/wireguard/status`).then((r) => readJson(r)).then(setWg).catch(() => {});
  }, []);
  import_react5.useEffect(loadNets, [loadNets]);
  import_react5.useEffect(() => {
    if (!tsLogin?.url || ts?.loggedIn)
      return;
  ...
  const joinTailnet = () => {
    ...
    fetch(`${ROUTE}/tailscale/login`, {
      ...
      if (b.joined)
        loadNets();
    }).catch((e) => setTsLogin({ error: e.message }));
  };
  const [busy, setBusy] = import_react5.useState(false);
  const [error, setError] = import_react5.useState("");
  const [openSettingsUrl, setOpenSettingsUrl] = import_react5.useState(null);
  const [me, setMe] = import_react5.useState(null);
  const [rws, setRws] = import_react5.useState([]);
  const [login, setLogin] = import_react5.useState(null);
  import_react5.useEffect(() => {
    fetch(`${ROUTE}/ssh-boxes`).then((r) => readJson(r)).then((b) => setSsh(b.boxes ?? [])).catch((e) => setError(e.message));
    fetch(`${ROUTE}/status`).then((r) => readJson(r)).then(setMe).catch(() => {});
    fetch(`${ROUTE}/remote-workspaces`).then((r) => readJson(r)).then((b) => setRws(b.workspaces ?? [])).catch(() => {});
  }, []);
  const refresh = () => {
    if (boxes.length === 0 && ssh.length === 0)
      return;
    setBusy(true);
    setError("");
    const jobs = [];
    if (boxes.length)
      jobs.push(fetch(`${ROUTE}/boxes/status`).then((r) => readJson(r)).then((b) => {
        setSelf(b.self ?? null);
        setProbe(Object.fromEntries((b.boxes ?? []).map((entry) => [entry.url, entry])));
      }));
    if (ssh.length)
      jobs.push(fetch(`${ROUTE}/ssh-boxes/status`).then((r) => readJson(r)).then((b) => setSshProbe(Object.fromEntries((b.boxes ?? []).map((e) => [e.host, e])))));
    loadNets();
    Promise.all(jobs).catch((e) => setError(e.message)).finally(() => setBusy(false));
  };
  import_react5.useEffect(refresh, [boxes.map((b) => b.url).join("|"), ssh.map((b) => b.host).join("|")]);
  const saveDsh = (next) => {
    setBusy(true);
    setError("");
  ...
  const saveSsh = (next) => {
    ...
    return fetch(`${ROUTE}/ssh-boxes`, {
      ...
      headers: { "content-type": "application/json" },
      body: JSON.stringify({ boxes: next })
    }).then((r) => readJson(r)).then((b) => setSsh(b.boxes ?? [])).catch((e) => setError(e.message)).finally(() => setBusy(false));
  };
  ...
  const add = (e) => {
    ...
    if (kind !== "dsh") {
      if (!draft.host.trim())
        return;
      const box = { name: draft.name.trim(), host: draft.host.trim() };
      if (kind !== "ssh")
        box.via = kind;
  ...
  const removeDsh = (url) => saveDsh(boxes.filter((b) => b.url !== url));
  const removeSsh = (host) => saveSsh(ssh.filter((b) => b.host !== host));
  const startLogin = (host) => {
    setLogin({ host, code: "", busy: true });
    fetch(`${ROUTE}/ssh-boxes/login/start`, {
      method: "POST",
      headers: { "content-type": "application/json" },
      body: JSON.stringify({ host })
    }).then((r) => readJson(r)).then((b) => setLogin({ host, code: "", url: b.url, error: b.error })).catch((e) => setLogin({ host, code: "", error: e.message }));
  };
  const submitLogin = () => {
    if (!login)
      return;
    ...
    fetch(`${ROUTE}/ssh-boxes/login/code`, {
      ...
      if (b.error)
        return setLogin({ host, code: "", error: b.error });
      setLogin(null);
      refresh();
    }).catch((e) => setLogin({ host, code: "", error: e.message }));
  };
  const removeRw = (path) => {
    setBusy(true);
    setError("");
    ...
    }).then((r) => readJson(r)).then((b) => setRws(b.workspaces ?? [])).catch((e) => setError(e.message)).finally(() => setBusy(false));
  };
  const total = boxes.length + ssh.length;
  const reachable = boxes.filter((b) => probe[b.url]?.ok).length + ssh.filter((b) => sshProbe[b.host]?.status?.binary).length;
  const summary = total === 0 ? "none saved" : `${total} saved · ${busy ? "checking…" : `${reachable} reachable`}`;
  const seg = (k, label) => /* @__PURE__ */ jsx_runtime5.jsx("button", {
    type: "button",
    style: kind === k ? { ...btn, background: CLAUDE_ORANGE, color: T.onBrand, border: "1px solid transparent" } : btn,
    onClick: () => setKind(k),
    children: label
  });
  return /* @__PURE__ */ jsx_runtime5.jsxs(Card, {
    ...
    title: "Boxes",
    summary,
    actions: open ? /* @__PURE__ */ jsx_runtime5.jsx("button", {
      type: "button",
      style: btn,
    ...
    children: [
      /* @__PURE__ */ jsx_runtime5.jsxs("p", {
        ...
        children: [
          "This box plus any you add. ",
          /* @__PURE__ */ jsx_runtime5.jsx("b", {
            children: "SSH"
          }),
          ": this dsh drives Claude Code on the box over ssh, so it shows up in the model picker with no dsh needed there. ",
          /* @__PURE__ */ jsx_runtime5.jsx("b", {
            children: "Link"
          }),
          ": it runs its own dsh with this plugin, so its sessions show in the archive and Open hops there. Each keeps its own Claude Code login."
        ]
      }),
      error && /* @__PURE__ */ jsx_runtime5.jsx("p", {
      ...
      me && /* @__PURE__ */ jsx_runtime5.jsxs("div", {
        "data-testid": "dsh-oh-my-claude-self-box-row",
        style: row,
        children: [
          /* @__PURE__ */ jsx_runtime5.jsxs("div", {
            style: { flex: 1, minWidth: 0 },
            children: [
              ...
              /* @__PURE__ */ jsx_runtime5.jsxs("div", {
                ...
                children: [
                  /* @__PURE__ */ jsx_runtime5.jsx("span", {
                    style: pill(CLAUDE_ORANGE),
                    children: "this box"
                  }),
                  me.host && /* @__PURE__ */ jsx_runtime5.jsx("span", {
                    style: { fontFamily: T.mono },
                    children: me.host
                  }),
                  /* @__PURE__ */ jsx_runtime5.jsx("span", {
                    style: pill(me.binary ? T.ok : T.err),
                    children: me.binary ? `claude ${me.version ?? ""}`.trim() : "claude not on PATH"
                  }),
                  /* @__PURE__ */ jsx_runtime5.jsx("span", {
                    style: pill(me.loggedIn ? T.ok : T.err),
                    children: me.loggedIn ? maskEmail(me.email ?? "logged in") : "not logged in"
                  }),
                  !me.loggedIn && /* @__PURE__ */ jsx_runtime5.jsxs("span", {
                    style: { width: "100%", color: T.err, fontSize: 12 },
                    children: [
                      "Run ",
                      ...
                      " in a terminal here, then refresh."
                    ]
                  })
                ]
              })
      ...
      ssh.map((b) => {
        ...
        return /* @__PURE__ */ jsx_runtime5.jsxs("div", {
          "data-testid": "dsh-oh-my-claude-ssh-box-row",
          style: row,
          children: [
            /* @__PURE__ */ jsx_runtime5.jsxs("div", {
              style: { flex: 1, minWidth: 0 },
              children: [
                ...
                /* @__PURE__ */ jsx_runtime5.jsxs("div", {
                  ...
                  children: [
                    ...
                    !st && /* @__PURE__ */ jsx_runtime5.jsx("span", {
                      style: pill(T.faint),
                      children: busy ? "checking" : "unchecked"
                    }),
                    st?.error && !st.reach && /* @__PURE__ */ jsx_runtime5.jsx("span", {
                      style: pill(T.err),
                      children: st.error
                    }),
                    st?.reach && st.reach.stage !== "ok" && /* @__PURE__ */ jsx_runtime5.jsx("span", {
                      style: pill(T.err),
                      title: st.reach.detail,
                      children: reachLabel(st.reach.stage)
                    }),
                    up && /* @__PURE__ */ jsx_runtime5.jsxs(jsx_runtime5.Fragment, {
                      children: [
                        /* @__PURE__ */ jsx_runtime5.jsx("span", {
                          style: pill(st.binary ? T.ok : T.err),
                          children: st.binary ? `claude ${st.version ?? ""}`.trim() : "no claude"
                        }),
                        /* @__PURE__ */ jsx_runtime5.jsx("span", {
                          style: pill(st.loggedIn ? T.ok : T.err),
                          children: st.loggedIn ? maskEmail(st.email ?? "logged in") : "not logged in"
                        }),
                        st.binary && !st.loggedIn && login?.host !== b.host && /* @__PURE__ */ jsx_runtime5.jsx("button", {
                          type: "button",
                          style: btn,
                          disabled: busy,
                ...
                st?.reach && st.reach.stage !== "ok" && /* @__PURE__ */ jsx_runtime5.jsx("div", {
                  style: { ...meta, whiteSpace: "normal", marginTop: 4, color: T.muted },
                  children: st.reach.hint.replaceAll("<host>", b.host)
                }),
                login?.host === b.host && /* @__PURE__ */ jsx_runtime5.jsxs("div", {
                  style: { ...meta, marginTop: 6, whiteSpace: "normal", overflowWrap: "anywhere" },
                  children: [
                    login.busy && !login.url && /* @__PURE__ */ jsx_runtime5.jsx("span", {
                      children: "starting login…"
                    }),
                    login.url && /* @__PURE__ */ jsx_runtime5.jsxs(jsx_runtime5.Fragment, {
                      children: [
                        /* @__PURE__ */ jsx_runtime5.jsxs("div", {
                          children: [
                            "1. Open this URL, sign in, copy the code:",
                            " ",
                            /* @__PURE__ */ jsx_runtime5.jsx("a", {
                              href: login.url,
                              target: "_blank",
                              rel: "noreferrer",
                              style: { color: CLAUDE_ORANGE },
                              children: "Claude sign-in"
                            })
                          ]
                        }),
                        /* @__PURE__ */ jsx_runtime5.jsxs("div", {
                    ...
                    login.error && /* @__PURE__ */ jsx_runtime5.jsx("div", {
                      style: { color: T.err, marginTop: 4 },
            ...
            /* @__PURE__ */ jsx_runtime5.jsx(ConfirmButton, {
              label: "Remove",
              style: btn,
              disabled: busy,
              ...
              children: [
                ...
                /* @__PURE__ */ jsx_runtime5.jsxs("div", {
                  ...
                  children: [
                    ...
                    st && !ok && /* @__PURE__ */ jsx_runtime5.jsx("span", {
                      style: pill(T.err),
                      children: st.error
                    }),
                    ok && st.status && /* @__PURE__ */ jsx_runtime5.jsxs(jsx_runtime5.Fragment, {
                      children: [
                        /* @__PURE__ */ jsx_runtime5.jsx("span", {
                          style: pill(T.faint),
      ...
      openSettingsUrl && /* @__PURE__ */ jsx_runtime5.jsx("div", {
        style: { padding: "0 0 4px" },
        children: /* @__PURE__ */ jsx_runtime5.jsx(SettingsEditor, {
          open: true,
      ...
      /* @__PURE__ */ jsx_runtime5.jsxs("form", {
        ...
        children: [
          ...
          kind === "ssh" ? /* @__PURE__ */ jsx_runtime5.jsx("input", {
            style: { ...inputStyle, flex: "1 1 240px" },
            placeholder: "user@host or ssh alias",
            value: draft.host,
            onChange: (e) => setDraft({ ...draft, host: e.target.value })
          }) : kind === "tailscale" ? /* @__PURE__ */ jsx_runtime5.jsxs(jsx_runtime5.Fragment, {
            children: [
              ts?.loggedIn && /* @__PURE__ */ jsx_runtime5.jsxs("select", {
                ...
                children: [
                  /* @__PURE__ */ jsx_runtime5.jsx("option", {
                    value: "",
                    children: "Pick a peer…"
                  }),
                  ts.peers.map((p) => /* @__PURE__ */ jsx_runtime5.jsxs("option", {
                    value: p.host,
                    disabled: peerIsSaved(p, ssh),
                    children: [
                      p.online ? "●" : "○",
                      " ",
                      p.name,
          ...
          }) : kind === "wireguard" ? /* @__PURE__ */ jsx_runtime5.jsxs(jsx_runtime5.Fragment, {
            children: [
              wg && wg.peers.length > 0 && /* @__PURE__ */ jsx_runtime5.jsxs("select", {
                style: { ...select, flex: "0 1 220px" },
                "aria-label": "WireGuard peer",
                value: wg.peers.find((p) => draft.host === p.host || draft.host.endsWith(`@${p.host}`))?.host ?? "",
                onChange: (e) => {
                  const peer = wg.peers.find((p) => p.host === e.target.value);
                  if (peer)
                    setDraft({ ...draft, host: peer.host });
                },
                children: [
                  /* @__PURE__ */ jsx_runtime5.jsx("option", {
                    value: "",
                  ...
                  wg.peers.map((p) => /* @__PURE__ */ jsx_runtime5.jsxs("option", {
                    value: p.host,
                    children: [
                      p.host,
                      " · ",
          ...
          /* @__PURE__ */ jsx_runtime5.jsx("button", {
            type: "submit",
            style: btn,
            disabled: busy || !draft.name.trim() || (kind !== "dsh" ? !draft.host.trim() : !draft.url.trim()),
            children: "Add"
          })
        ]
      }),
      kind === "tailscale" && /* @__PURE__ */ jsx_runtime5.jsx("div", {
        style: {
          ...meta,
          whiteSpace: "normal",
          marginTop: 6,
        ...
        children: ts === null ? "Checking this node's tailnet…" : !ts.installed ? /* @__PURE__ */ jsx_runtime5.jsxs(jsx_runtime5.Fragment, {
          children: [
            /* @__PURE__ */ jsx_runtime5.jsx("span", {
              style: pill(T.faint),
              children: "not installed"
            }),
            "Install Tailscale on this PC first (tailscale.com/download); the box side needs it too."
          ]
        }) : ts.loggedIn ? /* @__PURE__ */ jsx_runtime5.jsxs(jsx_runtime5.Fragment, {
          children: [
            /* @__PURE__ */ jsx_runtime5.jsx("span", {
              style: pill(T.ok),
              children: "on the tailnet"
            }),
            ts.self && /* @__PURE__ */ jsx_runtime5.jsx("span", {
              style: { fontFamily: T.mono },
              children: ts.self.host || ts.self.name
            }),
          ...
          children: [
            ...
            tsLogin?.url ? /* @__PURE__ */ jsx_runtime5.jsxs(jsx_runtime5.Fragment, {
              children: [
                /* @__PURE__ */ jsx_runtime5.jsx("a", {
                  href: tsLogin.url,
                  target: "_blank",
                  rel: "noreferrer",
                  style: { color: CLAUDE_ORANGE },
                  children: "Approve this PC on your tailnet"
                }),
                /* @__PURE__ */ jsx_runtime5.jsx("span", {
                  children: "waiting for the approval…"
                })
              ]
            }) : /* @__PURE__ */ jsx_runtime5.jsx("button", {
              type: "button",
              ...
              onClick: joinTailnet,
              children: tsLogin?.busy ? "Asking…" : "Connect"
            }),
            tsLogin?.error && /* @__PURE__ */ jsx_runtime5.jsx("span", {
              style: { color: T.err },
              children: tsLogin.error
            })
          ]
        })
      }),
      kind === "tailscale" && pickedPeer && /* @__PURE__ */ jsx_runtime5.jsx("div", {
        style: { ...meta, whiteSpace: "normal", marginTop: 4 },
        children: pickedPeer.tailscaleSsh ? `${pickedPeer.name} runs Tailscale SSH: no key to copy, ssh signs in with your tailnet identity.` : `${pickedPeer.name} needs an SSH key of yours, or Tailscale SSH turned on there (tailscale up --ssh).`
      }),
      kind === "wireguard" && /* @__PURE__ */ jsx_runtime5.jsx("div", {
        style: {
          ...meta,
          whiteSpace: "normal",
          marginTop: 6,
        ...
        children: wg === null ? "Checking WireGuard…" : !wg.installed ? /* @__PURE__ */ jsx_runtime5.jsxs(jsx_runtime5.Fragment, {
          children: [
            /* @__PURE__ */ jsx_runtime5.jsx("span", {
              style: pill(T.faint),
              children: "not installed"
        ...
        }) : wg.peers.length === 0 ? /* @__PURE__ */ jsx_runtime5.jsxs(jsx_runtime5.Fragment, {
          children: [
            /* @__PURE__ */ jsx_runtime5.jsx("span", {
              style: pill(T.warn),
              children: "no tunnel up"
            }),
            wg.error ? wg.error : "Bring one up with wg-quick, or type the peer's tunnel address."
          ]
        }) : /* @__PURE__ */ jsx_runtime5.jsxs(jsx_runtime5.Fragment, {
          children: [
            /* @__PURE__ */ jsx_runtime5.jsx("span", {
              style: pill(T.ok),
              children: wg.peers.length === 1 ? "1 peer" : `${wg.peers.length} peers`
            }),
      ...
      /* @__PURE__ */ jsx_runtime5.jsx("div", {
        style: { ...meta, whiteSpace: "normal", marginTop: 4 },
        children: kind !== "dsh" ? /* @__PURE__ */ jsx_runtime5.jsx(jsx_runtime5.Fragment, {
          children: "Key-based ssh, or Tailscale SSH on a tailnet. Not logged in there? The row offers a login; the panel tabs read the box the session runs on."
        }) : /* @__PURE__ */ jsx_runtime5.jsx(jsx_runtime5.Fragment, {
      ...
      /* @__PURE__ */ jsx_runtime5.jsxs("div", {
        ...
        children: [
          /* @__PURE__ */ jsx_runtime5.jsx("h3", {
            style: h3,
            children: "Remote workspaces"
          }),
          /* @__PURE__ */ jsx_runtime5.jsx("p", {
            style: { margin: "0 0 8px", color: T.muted, fontSize: 13 },
            children: "A directory on an SSH box, pinned as a workspace. It shows in the left sidebar like any workspace; pick the box's Claude in the model picker and the session runs in that remote folder. No files are copied; the box's Claude reads them there."
          }),
          rws.map((w) => /* @__PURE__ */ jsx_runtime5.jsxs("div", {
            "data-testid": "dsh-oh-my-claude-remote-ws-row",
            style: row,
            children: [
              /* @__PURE__ */ jsx_runtime5.jsxs("div", {
                style: { flex: 1, minWidth: 0 },
          ...
          /* @__PURE__ */ jsx_runtime5.jsxs("div", {
            style: { ...row, flexWrap: "wrap", paddingTop: 4 },
            children: [
              /* @__PURE__ */ jsx_runtime5.jsx("p", {
                style: { ...meta, whiteSpace: "normal", flex: "1 1 220px", margin: 0 },
                children: canAdd ? "Add one from the sidebar's Add workspace button: it browses whichever box you pick." : "Add an SSH box above first; the button then browses it."
              }),
              /* @__PURE__ */ jsx_runtime5.jsx("button", {
                type: "button",
                style: btn,
...
var handshakeText = (age) => age === null ? "never" : age < 90 ? `${age}s ago` : `${Math.round(age / 60)}m ago`;
var peerIsSaved = (peer, boxes) => boxes.some((b) => b.host === peer.host || b.host.endsWith(`@${peer.host}`));
var reachLabel = (stage) => {
  switch (stage) {
    case "dns":
...
var loadContext = (sessionId) => {
  const hit = contextCache.get(sessionId);
  if (hit && Date.now() - hit.at < 1e4)
    return hit.reply;
  const reply = (async () => {
    try {
...
var observeBody = (observer) => {
  observer.observe(document.body, { childList: true, subtree: true });
};
var onBodyMutation = (scan, sync = false) => {
  ...
  bodyObserver = new MutationObserver((records) => {
    for (const run of syncScans)
      run(records);
    if (scanQueued || frameScans.size === 0)
      return;
    scanQueued = true;
...
var verbFor = (sessionId, verbs) => {
  const now = Date.now();
  for (const [id, seen] of turnVerbs)
    if (now - seen.seen >= VERB_MEMORY_MS)
      turnVerbs.delete(id);
...
var TURN_MARK = "data-dsh-oh-my-claude-turn";
var wireTurnStatus = (el, sessionId, verbs, frames) => {
  ensureTurnStatusStyle();
  if (el.hasAttribute(TURN_MARK))
    return;
...
var TOOL_ICONS = "❯▤✎⌕✳⤓☑⚙☰⌘◆";
var FOLD_MARK = "⁠";
var markedHeaders = false;
var HEAD_MARK = "data-omc-tool";
var LEAD_MARK = "data-omc-lead";
var SPRITE_MARK = "data-omc-sprite";
var SPRITES = {
  "❯": import_dsh_client_ui_primitives2.IconApiOutline14,
  "▤": import_dsh_client_ui_primitives2.IconBrowseOutline16,
  "✎": import_dsh_client_ui_primitives2.IconEditOutline16,
  "⌕": import_dsh_client_ui_primitives2.IconSearchOutline16,
  "✳": import_dsh_client_ui_primitives2.IconCodeOutline16,
  "⤓": import_dsh_client_ui_primitives2.IconBrowseOutline16,
  "☑": import_dsh_client_ui_primitives2.IconChecklistOutline14,
  "⚙": import_dsh_client_ui_primitives2.IconAgentPresetOutline16,
  "☰": import_dsh_client_ui_primitives2.IconListPenOutline16,
  "⌘": import_dsh_client_ui_primitives2.IconSkillOutline16,
  "◆": import_dsh_client_ui_primitives2.IconSparkle16,
  chevron: import_dsh_client_ui_primitives2.IconChevronDownOutline14
};
function ToolIconSprites() {
  return /* @__PURE__ */ jsx_runtime5.jsx("span", {
    hidden: true,
    children: Object.entries(SPRITES).map(([key, Icon]) => /* @__PURE__ */ jsx_runtime5.jsx("span", {
      [SPRITE_MARK]: key,
      children: /* @__PURE__ */ jsx_runtime5.jsx(Icon, {
        size: 14
      })
    }, key))
  });
...
var ensureFoldStyle = () => {
  ...
  const half = "8px - var(--dsh-content-font-delta,0px)/2";
  el.textContent = [
...
var bindFoldClicks = () => {
  ...
  const toggle = (target) => {
    if (!(target instanceof Element))
      return false;
    const head = target.closest(`p[${HEAD_MARK}]`);
    const state = head?.getAttribute(HEAD_MARK);
    if (head === null || state === "flat" || state === null)
      return false;
...
var glyphOf = (head) => {
  ...
  if (node?.nodeType === Node.TEXT_NODE) {
    ...
    if (at >= 0 && TOOL_ICONS.includes(text.charAt(at))) {
      if (text.startsWith(FOLD_MARK, at + 1))
        markedHeaders = true;
      else if (markedHeaders && !head.hasAttribute(HEAD_MARK))
        return "";
      return text.charAt(at);
    }
  }
  return head.querySelector(`span[${LEAD_MARK}]`)?.getAttribute(LEAD_MARK) ?? head.getAttribute("data-omc-icon") ?? "";
};
function watchToolFolds() {
  ...
  const headsIn = (records) => {
    const heads = new Set;
    const take = (node) => {
      if (!(node instanceof HTMLElement))
        return;
      if (node.tagName === "P") {
        if (node.closest('[class*="_markdown"]') !== null)
          heads.add(node);
        return;
      }
      for (const head of node.querySelectorAll(MARKDOWN_P))
        heads.add(head);
    };
  ...
  const scan = (records) => {
    ...
    sweepAgain = false;
    for (const head of wide ? document.querySelectorAll(MARKDOWN_P) : headsIn(records))
      visit(head);
  };
  scan();
  onBodyMutation(scan, true);
}
var MODULE_ROOT = /(?:^|\s)[\w-]*_root(?:\s|$)/;
var STATS_SEP = ':scope > span[aria-hidden="true"][class$="_sep"]';
var isStatsRow = (el) => {
  if (!el.isConnected || el.children.length < 1)
    return false;
  if (el.hasAttribute("data-composer-stats"))
    return true;
...
function CostLine({ sessionId, ctx }) {
  const [turns, setTurns] = import_react5.useState([]);
  const turnsRef = import_react5.useRef([]);
  turnsRef.current = turns;
  const visibleRef = import_react5.useRef(true);
  import_react5.useEffect(() => {
    let alive = true;
  ...
  const mineRef = import_react5.useRef(false);
  const current = ctx.sessions.list.getSnapshot()?.current;
  const mine = activeClaudeSession(ctx) === sessionId ? true : current && current !== sessionId ? false : mineRef.current;
  ...
  const anchorRef = import_react5.useRef(null);
  const [hooked, setHooked] = import_react5.useState(false);
  const textRef = import_react5.useRef(text);
  const titleRef = import_react5.useRef(title);
  import_react5.useLayoutEffect(() => {
    textRef.current = text;
    titleRef.current = title;
  });
  const syncRef = import_react5.useRef(() => {});
  import_react5.useEffect(() => syncRef.current(), [text, title]);
  import_react5.useEffect(() => {
    let inline;
    let body;
    let rowLead = "";
    ...
    const tryHook = () => {
      ...
      const rowIn = (root) => [...root.querySelectorAll("div")].filter(isStatsRow).at(-1);
      const statsRow = lastRow && isStatsRow(lastRow) ? lastRow : (lastHost?.isConnected === true ? rowIn(lastHost) : undefined) ?? rowIn(document);
      lastRow = statsRow;
      ...
      const proto = statsRow.hasAttribute("data-composer-stats") ? statsRow.firstElementChild?.firstElementChild : null;
  ...
  return /* @__PURE__ */ jsx_runtime5.jsx("span", {
    ...
    children: /* @__PURE__ */ jsx_runtime5.jsxs("span", {
      title,
...
function StarterCard({
  ...
  const [starter, setStarter] = import_react5.useState(null);
  const [note, setNote] = import_react5.useState("");
  import_react5.useEffect(() => {
    let live = true;
    fetch(`${ROUTE}/starter?session=${encodeURIComponent(sessionId)}`).then((r) => readJson(r)).then((b) => {
      if (live)
        setStarter(b);
    }).catch(() => {});
    return () => {
  ...
  const blank = ctx.sessions.list.getSnapshot()?.byId[sessionId]?.blank !== false;
  if (!blank || starter === null)
    return null;
  const opener = starter.session || starter.fallback;
  const busy = draft !== "" && draft !== opener;
  const chip = {
    ...btn,
    fontSize: 12,
    padding: "2px 8px",
  ...
  return /* @__PURE__ */ jsx_runtime5.jsx("div", {
    ...
    children: /* @__PURE__ */ jsx_runtime5.jsxs("div", {
      ...
      children: [
        opener === "" || busy ? /* @__PURE__ */ jsx_runtime5.jsx("span", {
          children: "Type a prompt to start. Save it here to open the next session with it."
        }) : /* @__PURE__ */ jsx_runtime5.jsxs(jsx_runtime5.Fragment, {
          children: [
            /* @__PURE__ */ jsx_runtime5.jsx("button", {
              type: "button",
              ...
              title: opener,
              children: opener.length > 60 ? `${opener.slice(0, 60)}…` : opener
            }),
            /* @__PURE__ */ jsx_runtime5.jsx("span", {
              children: "fills the composer; edit before sending."
            })
          ]
        }),
        /* @__PURE__ */ jsx_runtime5.jsx("span", {
        ...
        draft === "" ? null : /* @__PURE__ */ jsx_runtime5.jsx("button", {
          type: "button",
          style: chip,
          onClick: () => save(draft),
          title: "Save what is in the composer as this session's opening prompt",
          children: note === "" ? "Save draft" : note
        }),
        opener === "" ? null : /* @__PURE__ */ jsx_runtime5.jsx(ConfirmButton, {
          label: "Forget",
          style: chip,
          disabled: false,
          onAct: () => save("")
...
function StarterSlot({
  ...
  if (sessionId === undefined || inputActions === undefined)
    return null;
  return /* @__PURE__ */ jsx_runtime5.jsx(StarterCard, {
    sessionId,
    ctx,
    draft,
...
function AsideBubble({ sessionId, ctx }) {
  const [items, setItems] = import_react5.useState([]);
  const itemsRef = import_react5.useRef([]);
  itemsRef.current = items;
  const [dismissed, setDismissed] = import_react5.useState(() => new Set);
  const [copied, setCopied] = import_react5.useState(null);
  const [toggled, setToggled] = import_react5.useState(() => new Set);
  const visibleRef = import_react5.useRef(true);
  import_react5.useEffect(() => {
    let alive = true;
    const fetchItems = async () => {
      try {
        ...
        if (alive && JSON.stringify(next) !== JSON.stringify(itemsRef.current))
          setItems(next);
      } catch {}
    };
    fetchItems();
  ...
  const toggle = (id) => setToggled((prev) => {
      ...
      return /* @__PURE__ */ jsx_runtime5.jsxs("div", {
        ...
        children: [
          /* @__PURE__ */ jsx_runtime5.jsxs("div", {
            ...
            children: [
              /* @__PURE__ */ jsx_runtime5.jsx(Spark, {
                size: 12
              }),
              /* @__PURE__ */ jsx_runtime5.jsx("span", {
                style: {
          ...
          open ? /* @__PURE__ */ jsx_runtime5.jsx("div", {
            style: { padding: "0 10px 8px 24px", maxHeight: "40vh", overflow: "auto" },
            children: it.pending ? /* @__PURE__ */ jsx_runtime5.jsx("div", {
              style: { color: CLAUDE_ORANGE, fontSize: 12, fontStyle: "italic" },
              children: "Claude is thinking…"
            }) : it.error ? /* @__PURE__ */ jsx_runtime5.jsx("div", {
...
function IdleChip({ sessionId }) {
  const [deadline, setDeadline] = import_react5.useState(null);
  const visibleRef = import_react5.useRef(true);
  import_react5.useEffect(() => {
    let alive = true;
...
function apply(ctx) {
  ...
  function Section(props) {
    const [boxes, setBoxes] = import_react5.useState([]);
    const [openBoxes, setOpenBoxes] = import_react5.useState(true);
    const [openSessions, setOpenSessions] = import_react5.useState(false);
    const [error, setError] = import_react5.useState("");
    import_react5.useEffect(() => {
    ...
    return /* @__PURE__ */ jsx_runtime5.jsxs("div", {
      children: [
        ...
        boxes !== null && /* @__PURE__ */ jsx_runtime5.jsx(Card, {
          id: "dsh-oh-my-claude-sessions-card",
          title: "Archived Sessions",
          open: openSessions,
          onToggle: () => setOpenSessions((v) => !v),
          children: /* @__PURE__ */ jsx_runtime5.jsx(Sessions, {
            ctx,
            boxes,
            close: props.close
          })
        }),
        boxes !== null && /* @__PURE__ */ jsx_runtime5.jsx(Boxes, {
          ctx,
          boxes,
          setBoxes,
          open: openBoxes,
  ...
  ctx.slots.inject("conversation.composer.dock", () => {
    ctx.slots.register({ name: "conversation.composer.dock", id: "claude-cost", order: 10 }, (props) => props.sessionId ? /* @__PURE__ */ jsx_runtime5.jsx(CostLine, {
  ...
  ctx.slots.inject("conversation.input.dock", () => {
    ctx.slots.register({ name: "conversation.input.dock", id: "claude-aside", order: 45 }, (props) => props.sessionId ? /* @__PURE__ */ jsx_runtime5.jsx(AsideBubble, {
      sessionId: props.sessionId,
      ctx
    }) : null);
    ctx.slots.register({ name: "conversation.input.dock", id: "claude-starter", order: 44 }, (props) => /* @__PURE__ */ jsx_runtime5.jsx(StarterSlot, {
      ...props,
      ctx
    }));
    ctx.slots.register({ name: "conversation.input.dock", id: "claude-tool-icons", order: 46 }, () => /* @__PURE__ */ jsx_runtime5.jsx(ToolIconSprites, {}));
    return null;
  });
  ctx.slots.inject("sidebar.footer.action", () => {
    ctx.slots.register({ name: "sidebar.footer.action", id: "claude-add-workspace", order: 90 }, () => /* @__PURE__ */ jsx_runtime5.jsx(AddWorkspaceFlow, {
      ctx
    }));
    return null;
  });
  ctx.slots.inject("conversation.session.header.actions", () => {
    ctx.slots.register({ name: "conversation.session.header.actions", id: "claude-idle-warn", order: 31 }, (props) => props.sessionId ? /* @__PURE__ */ jsx_runtime5.jsx(IdleChip, {
      sessionId: props.sessionId
    }) : null);
    return null;
  });
  ctx.slots.inject("conversation.input.left", () => {
    ctx.slots.register({ name: "conversation.input.left", id: "claude-access", order: 40 }, (props) => props.sessionId ? /* @__PURE__ */ jsx_runtime5.jsx(AccessShield, {
      sessionId: props.sessionId,
      ctx
    }) : null);
    ctx.slots.register({ name: "conversation.input.left", id: "oh-my-claude", order: 50 }, (props) => props.sessionId ? /* @__PURE__ */ jsx_runtime5.jsx(OhMyClaudeControl, {
      sessionId: props.sessionId,
      ctx
    }) : null);
    return null;
