...
function PermissionsBody({ sessionId, ctx }) {
  const [state, setState] = import_react2.useState(null);
  const [busy, setBusy] = import_react2.useState(false);
  const [error, setError] = import_react2.useState("");
  const isClaude = activeClaudeSession(ctx) === sessionId;
  import_react2.useEffect(() => {
  ...
  return /* @__PURE__ */ jsx_runtime.jsxs("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx_runtime.jsx("span", {
        style: { color: T.faint, fontSize: 12 },
        children: "Override can only be stricter than the shield."
      }),
      state.modes.length > 1 && /* @__PURE__ */ jsx_runtime.jsxs("select", {
      ...
      (state.override || state.modes.length <= 1) && /* @__PURE__ */ jsx_runtime.jsx("button", {
        type: "button",
        style: btn,
        onClick: () => change(""),
        children: "Use config"
        ...
        children: [
          ...
          /* @__PURE__ */ jsx_runtime.jsxs("div", {
            ...
            children: [
              ...
              tab === "Permissions" && /* @__PURE__ */ jsx_runtime.jsx(PermissionsBody, {
                sessionId,
                ctx
              })
            ]
