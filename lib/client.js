...
function AsidesBody({ sessionId }) {
  ...
  return /* @__PURE__ */ jsx_runtime3.jsx("div", {
    style: bodyFlow,
    children: items.toReversed().map((it) => /* @__PURE__ */ jsx_runtime3.jsxs("div", {
      style: { padding: "4px 10px", fontSize: 12, lineHeight: "1.5" },
      children: [
        /* @__PURE__ */ jsx_runtime3.jsx("div", {
          style: { color: T.text, whiteSpace: "pre-wrap", wordBreak: "break-word" },
        ...
        /* @__PURE__ */ jsx_runtime3.jsxs("div", {
          style: { ...meta, fontSize: 11, marginTop: 2 },
          children: [
            ago(it.at),
