...
function ConfirmButton({
  ...
  const [armed, setArmed] = import_react3.useState(false);
  import_react3.useEffect(() => {
    if (!armed)
      return;
...
function Chevron({ open }) {
  return /* @__PURE__ */ jsx_runtime4.jsx("span", {
    ...
    children: /* @__PURE__ */ jsx_runtime4.jsx("svg", {
      ...
      viewBox: "0 0 14 14",
      fill: "none",
      children: /* @__PURE__ */ jsx_runtime4.jsx("polyline", {
      ...
      /* @__PURE__ */ jsx_runtime4.jsxs("div", {
        ...
        children: [
          /* @__PURE__ */ jsx_runtime4.jsxs("button", {
            ...
            children: [
              /* @__PURE__ */ jsx_runtime4.jsx(Chevron, {
                open
              }),
              ...
              summary && /* @__PURE__ */ jsx_runtime4.jsx("span", {
                style: { ...meta, whiteSpace: "normal", overflow: "hidden" },
                children: summary
              })
            ]
          }),
          actions && /* @__PURE__ */ jsx_runtime4.jsx("div", {
            style: { display: "flex", gap: 8 },
            children: actions
          })
        ]
      }),
      open && /* @__PURE__ */ jsx_runtime4.jsx("div", {
        style: { marginTop: 10 },
        children
      })
    ]
...
function Sessions({ ctx, boxes, close }) {
  ...
  const [picked, setPicked] = import_react4.useState(new Set);
  const [moving, setMoving] = import_react4.useState("");
  const fileInput = import_react4.useRef(null);
  const load = () => {
    setLoading(true);
    setError("");
  ...
  return /* @__PURE__ */ jsx_runtime4.jsxs("div", {
    children: [
      /* @__PURE__ */ jsx_runtime4.jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx_runtime4.jsxs("div", {
            ...
            children: [
              moving && /* @__PURE__ */ jsx_runtime4.jsx("span", {
                style: meta,
                children: moving
              }),
              picked.size > 0 && /* @__PURE__ */ jsx_runtime4.jsxs("button", {
        ...
        children: [
          /* @__PURE__ */ jsx_runtime4.jsxs("select", {
            ...
            children: [
              ...
              groups.map((g) => /* @__PURE__ */ jsx_runtime4.jsxs("option", {
                value: g.key,
                disabled: !g.ok,
          ...
          /* @__PURE__ */ jsx_runtime4.jsxs("select", {
            ...
            children: [
              ...
              cwds.map((c) => /* @__PURE__ */ jsx_runtime4.jsx("option", {
                value: c,
                title: c,
      ...
      !loading && rows.length === 0 && /* @__PURE__ */ jsx_runtime4.jsx("p", {
      ...
      /* @__PURE__ */ jsx_runtime4.jsxs("div", {
        ...
        children: [
                ...
                /* @__PURE__ */ jsx_runtime4.jsxs("div", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx_runtime4.jsxs("div", {
                      ...
                      children: [
                        multiBox && /* @__PURE__ */ jsx_runtime4.jsx("span", {
                          style: pill(T.faint),
                          title: r.g.host,
                          children: r.g.host ?? r.g.name
                        }),
                        /* @__PURE__ */ jsx_runtime4.jsx(Origin, {
                          s: r.s
                        }),
                        r.s.cwd && /* @__PURE__ */ jsx_runtime4.jsx("span", {
                          title: r.s.cwd,
                          style: {
                            fontFamily: T.mono,
                            minWidth: 0,
          ...
          more > 0 && /* @__PURE__ */ jsx_runtime4.jsxs("div", {
            ...
            children: [
              ...
              grown && /* @__PURE__ */ jsx_runtime4.jsxs("button", {
                type: "button",
                style: btn,
...
function SettingsEditor({ open, onToggle, box, ctx }) {
  ...
  const actions = editing ? /* @__PURE__ */ jsx_runtime4.jsxs(jsx_runtime4.Fragment, {
    children: [
      /* @__PURE__ */ jsx_runtime4.jsx("button", {
  ...
  }) : open ? /* @__PURE__ */ jsx_runtime4.jsxs(jsx_runtime4.Fragment, {
    children: [
      /* @__PURE__ */ jsx_runtime4.jsx("button", {
        type: "button",
        style: btn,
  ...
  return /* @__PURE__ */ jsx_runtime4.jsxs(Card, {
    ...
    children: [
      ...
      !box && /* @__PURE__ */ jsx_runtime4.jsxs(jsx_runtime4.Fragment, {
        children: [
          /* @__PURE__ */ jsx_runtime4.jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx_runtime4.jsx("select", {
                ...
                children: SETTINGS_SCOPES.toReversed().map((s) => /* @__PURE__ */ jsx_runtime4.jsx("option", {
                  value: s,
                  disabled: cwdOptions.length === 0 && (s === "project" || s === "local"),
                  children: s
                }, s))
              }),
              (scope === "project" || scope === "local") && (cwdOptions.length > 0 ? /* @__PURE__ */ jsx_runtime4.jsx("select", {
                value: projectCwd ?? "",
                onChange: (e) => setCwd(e.target.value),
                disabled: busy || editing,
                style: { ...inputStyle, padding: "4px 6px", fontSize: 12, flex: 1 },
                children: cwdOptions.map((c) => /* @__PURE__ */ jsx_runtime4.jsx("option", {
                  value: c,
                  children: c
                }, c))
              }) : /* @__PURE__ */ jsx_runtime4.jsx("span", {
          ...
          (readOnly || override) && /* @__PURE__ */ jsx_runtime4.jsxs("div", {
      ...
      editing ? /* @__PURE__ */ jsx_runtime4.jsx("textarea", {
      ...
      /* @__PURE__ */ jsx_runtime4.jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx_runtime4.jsx("span", {
            ...
            children: error ? /* @__PURE__ */ jsx_runtime4.jsx("span", {
              style: { color: T.err },
              children: error
...
function Boxes({ boxes, setBoxes, open, onToggle }) {
  ...
  const [ssh, setSsh] = import_react4.useState([]);
  const [sshProbe, setSshProbe] = import_react4.useState({});
  const [kind, setKind] = import_react4.useState("ssh");
  const [draft, setDraft] = import_react4.useState({ name: "", url: "", token: "", host: "" });
  const [ts, setTs] = import_react4.useState(null);
  const [wg, setWg] = import_react4.useState(null);
  const [pickedPeer, setPickedPeer] = import_react4.useState(null);
  const [tsLogin, setTsLogin] = import_react4.useState(null);
  const [tsServer, setTsServer] = import_react4.useState({ loginServer: "", authKey: "" });
  const loadNets = import_react4.useCallback(() => {
  ...
  import_react4.useEffect(loadNets, [loadNets]);
  import_react4.useEffect(() => {
  ...
  const [me, setMe] = import_react4.useState(null);
  const [rws, setRws] = import_react4.useState([]);
  const [wsDraft, setWsDraft] = import_react4.useState({ name: "", host: "", remoteCwd: "" });
  const [login, setLogin] = import_react4.useState(null);
  import_react4.useEffect(() => {
  ...
  import_react4.useEffect(refresh, [boxes.map((b) => b.url).join("|"), ssh.map((b) => b.host).join("|")]);
  const saveDsh = (next) => {
    setBusy(true);
    setError("");
  ...
  const seg = (k, label) => /* @__PURE__ */ jsx_runtime4.jsx("button", {
    type: "button",
  ...
  return /* @__PURE__ */ jsx_runtime4.jsxs(Card, {
    ...
    title: "Boxes",
    summary,
    actions: open ? /* @__PURE__ */ jsx_runtime4.jsx("button", {
      type: "button",
      style: btn,
    ...
    children: [
      /* @__PURE__ */ jsx_runtime4.jsxs("p", {
        ...
        children: [
          ...
          ": this dsh drives Claude Code on the box over ssh — it shows up in the model picker, no dsh needed there. ",
          /* @__PURE__ */ jsx_runtime4.jsx("b", {
            children: "Link"
          }),
          ": it runs its own dsh with this plugin — its sessions show in the archive and Open hops there. Each keeps its own Claude Code login."
        ]
      }),
      error && /* @__PURE__ */ jsx_runtime4.jsx("p", {
      ...
      me && /* @__PURE__ */ jsx_runtime4.jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx_runtime4.jsxs("div", {
                ...
                children: [
                  ...
                  me.host && /* @__PURE__ */ jsx_runtime4.jsx("span", {
                    style: { fontFamily: T.mono },
                    children: me.host
                  }),
                  /* @__PURE__ */ jsx_runtime4.jsx("span", {
                  ...
                  !me.loggedIn && /* @__PURE__ */ jsx_runtime4.jsxs("span", {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx_runtime4.jsxs("div", {
                  ...
                  children: [
                    ...
                    !st && /* @__PURE__ */ jsx_runtime4.jsx("span", {
                      style: pill(T.faint),
                      children: busy ? "checking" : "unchecked"
                    }),
                    st?.error && !st.reach && /* @__PURE__ */ jsx_runtime4.jsx("span", {
                      style: pill(T.err),
                      children: st.error
                    }),
                    st?.reach && st.reach.stage !== "ok" && /* @__PURE__ */ jsx_runtime4.jsx("span", {
                      style: pill(T.err),
                      title: st.reach.detail,
                      children: reachLabel(st.reach.stage)
                    }),
                    up && /* @__PURE__ */ jsx_runtime4.jsxs(jsx_runtime4.Fragment, {
                      children: [
                        /* @__PURE__ */ jsx_runtime4.jsx("span", {
                        ...
                        st.binary && !st.loggedIn && login?.host !== b.host && /* @__PURE__ */ jsx_runtime4.jsx("button", {
                          type: "button",
                          style: btn,
                          disabled: busy,
                ...
                st?.reach && st.reach.stage !== "ok" && /* @__PURE__ */ jsx_runtime4.jsx("div", {
                  style: { ...meta, whiteSpace: "normal", marginTop: 4, color: T.muted },
                  children: st.reach.hint.replaceAll("<host>", b.host)
                }),
                login?.host === b.host && /* @__PURE__ */ jsx_runtime4.jsxs("div", {
                  style: { ...meta, marginTop: 6, whiteSpace: "normal", overflowWrap: "anywhere" },
                  children: [
                    login.busy && !login.url && /* @__PURE__ */ jsx_runtime4.jsx("span", {
                      children: "starting login…"
                    }),
                    login.url && /* @__PURE__ */ jsx_runtime4.jsxs(jsx_runtime4.Fragment, {
                      children: [
                        /* @__PURE__ */ jsx_runtime4.jsxs("div", {
                          children: [
                            "1. Open this URL, sign in, copy the code:",
                            " ",
                            /* @__PURE__ */ jsx_runtime4.jsx("a", {
                              href: login.url,
                              target: "_blank",
                              rel: "noreferrer",
                    ...
                    login.error && /* @__PURE__ */ jsx_runtime4.jsx("div", {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx_runtime4.jsxs("div", {
                  ...
                  children: [
                    ...
                    st && !ok && /* @__PURE__ */ jsx_runtime4.jsx("span", {
                      style: pill(T.err),
                      children: st.error
                    }),
                    ok && st.status && /* @__PURE__ */ jsx_runtime4.jsxs(jsx_runtime4.Fragment, {
                      children: [
                        /* @__PURE__ */ jsx_runtime4.jsx("span", {
                          style: pill(T.faint),
      ...
      openSettingsUrl && /* @__PURE__ */ jsx_runtime4.jsx("div", {
        style: { padding: "0 0 4px" },
        children: /* @__PURE__ */ jsx_runtime4.jsx(SettingsEditor, {
          open: true,
          onToggle: () => setOpenSettingsUrl(null),
          box: boxes.find((b) => b.url === openSettingsUrl)
        })
      }),
      /* @__PURE__ */ jsx_runtime4.jsxs("form", {
        onSubmit: add,
        style: {
          ...row,
        ...
        children: [
          ...
          kind === "ssh" ? /* @__PURE__ */ jsx_runtime4.jsx("input", {
            style: { ...inputStyle, flex: "1 1 240px" },
            placeholder: "user@host or ssh alias",
            value: draft.host,
            onChange: (e) => setDraft({ ...draft, host: e.target.value })
          }) : kind === "tailscale" ? /* @__PURE__ */ jsx_runtime4.jsxs(jsx_runtime4.Fragment, {
            children: [
              ts?.loggedIn && /* @__PURE__ */ jsx_runtime4.jsxs("select", {
                ...
                children: [
                  ...
                  ts.peers.map((p) => /* @__PURE__ */ jsx_runtime4.jsxs("option", {
                    value: p.host,
          ...
          }) : kind === "wireguard" ? /* @__PURE__ */ jsx_runtime4.jsxs(jsx_runtime4.Fragment, {
            children: [
              wg && wg.peers.length > 0 && /* @__PURE__ */ jsx_runtime4.jsxs("select", {
                style: { ...select, flex: "0 1 220px" },
                ...
                children: [
                  ...
                  wg.peers.map((p) => /* @__PURE__ */ jsx_runtime4.jsxs("option", {
                    value: p.host,
                    children: [
                      p.host,
                      " · ",
      ...
      kind === "tailscale" && /* @__PURE__ */ jsx_runtime4.jsx("div", {
        style: {
          ...meta,
          whiteSpace: "normal",
          marginTop: 6,
        ...
        children: ts === null ? "Checking this node's tailnet…" : !ts.installed ? /* @__PURE__ */ jsx_runtime4.jsxs(jsx_runtime4.Fragment, {
          children: [
            /* @__PURE__ */ jsx_runtime4.jsx("span", {
              style: pill(T.faint),
        ...
        }) : ts.loggedIn ? /* @__PURE__ */ jsx_runtime4.jsxs(jsx_runtime4.Fragment, {
          children: [
            /* @__PURE__ */ jsx_runtime4.jsx("span", {
              style: pill(T.ok),
              children: "on the tailnet"
            }),
            ts.self && /* @__PURE__ */ jsx_runtime4.jsx("span", {
              style: { fontFamily: T.mono },
          ...
          children: [
            ...
            tsLogin?.url ? /* @__PURE__ */ jsx_runtime4.jsxs(jsx_runtime4.Fragment, {
              children: [
                /* @__PURE__ */ jsx_runtime4.jsx("a", {
                  href: tsLogin.url,
                  target: "_blank",
            ...
            tsLogin?.error && /* @__PURE__ */ jsx_runtime4.jsx("span", {
              style: { color: T.err },
      ...
      kind === "tailscale" && pickedPeer && /* @__PURE__ */ jsx_runtime4.jsx("div", {
      ...
      kind === "wireguard" && /* @__PURE__ */ jsx_runtime4.jsx("div", {
        style: {
          ...meta,
          whiteSpace: "normal",
          marginTop: 6,
        ...
        children: wg === null ? "Checking WireGuard…" : !wg.installed ? /* @__PURE__ */ jsx_runtime4.jsxs(jsx_runtime4.Fragment, {
          children: [
            /* @__PURE__ */ jsx_runtime4.jsx("span", {
              style: pill(T.faint),
              children: "not installed"
        ...
        }) : wg.peers.length === 0 ? /* @__PURE__ */ jsx_runtime4.jsxs(jsx_runtime4.Fragment, {
          children: [
            /* @__PURE__ */ jsx_runtime4.jsx("span", {
              style: pill(T.warn),
      ...
      /* @__PURE__ */ jsx_runtime4.jsx("div", {
        style: { ...meta, whiteSpace: "normal", marginTop: 4 },
        children: kind !== "dsh" ? /* @__PURE__ */ jsx_runtime4.jsx(jsx_runtime4.Fragment, {
      ...
      /* @__PURE__ */ jsx_runtime4.jsxs("div", {
        ...
        children: [
          ...
          rws.map((w) => /* @__PURE__ */ jsx_runtime4.jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx_runtime4.jsx("button", {
                ...
                style: btn,
                disabled: busy,
                onClick: () => removeRw(w.path),
                children: "Remove"
              })
            ]
          }, `rw:${w.path}`)),
          ssh.length === 0 ? /* @__PURE__ */ jsx_runtime4.jsx("p", {
            style: { ...meta, whiteSpace: "normal", marginTop: 4 },
            ...
            children: [
              /* @__PURE__ */ jsx_runtime4.jsx("select", {
                ...
                children: ssh.map((b) => /* @__PURE__ */ jsx_runtime4.jsx("option", {
                  value: b.host,
                  children: b.name
                }, b.host))
              }),
...
var ensureTurnStatusStyle = () => {
  ...
  styleEl.textContent = `body[data-omc-claude] [role="status"][aria-live="polite"],[data-dsh-oh-my-claude-turn]{background-image:linear-gradient(90deg,${CLAUDE_ORANGE} 0%,${CLAUDE_ORANGE} 40%,${CLAUDE_SHIMMER} 50%,${CLAUDE_ORANGE} 60%,${CLAUDE_ORANGE} 100%)}[data-dsh-oh-my-claude-turn]>span[aria-hidden]{display:inline-block;width:1.3em;text-align:start;flex:none}body[data-omc-claude] [role="tablist"]>[role="tab"][aria-selected="true"]{color:${CLAUDE_ORANGE}}body[data-omc-claude] [role="tablist"]>[role="tab"][aria-selected="true"]::after{background:${CLAUDE_ORANGE}}body[data-omc-claude] [class*="_markdown"] blockquote{border-left-color:${CLAUDE_ORANGE}80}body[data-omc-claude] [class*="_markdown"] hr{background:${CLAUDE_ORANGE}59}`;
...
var SPRITES = {
  "❯": import_dsh_client_ui_primitives.IconApiOutline14,
  "▤": import_dsh_client_ui_primitives.IconBrowseOutline16,
  "✎": import_dsh_client_ui_primitives.IconEditOutline16,
  "⌕": import_dsh_client_ui_primitives.IconSearchOutline16,
  "✳": import_dsh_client_ui_primitives.IconCodeOutline16,
  "⤓": import_dsh_client_ui_primitives.IconBrowseOutline16,
  "☑": import_dsh_client_ui_primitives.IconChecklistOutline14,
  "⚙": import_dsh_client_ui_primitives.IconAgentPresetOutline16,
  "☰": import_dsh_client_ui_primitives.IconListPenOutline16,
  "⌘": import_dsh_client_ui_primitives.IconSkillOutline16,
  "◆": import_dsh_client_ui_primitives.IconSparkle16,
  chevron: import_dsh_client_ui_primitives.IconChevronDownOutline14
};
function ToolIconSprites() {
  return /* @__PURE__ */ jsx_runtime4.jsx("span", {
    hidden: true,
    children: Object.entries(SPRITES).map(([key, Icon]) => /* @__PURE__ */ jsx_runtime4.jsx("span", {
      [SPRITE_MARK]: key,
      children: /* @__PURE__ */ jsx_runtime4.jsx(Icon, {
        size: 14
      })
    }, key))
  });
...
var isStatsRow = (el) => {
  if (!el.isConnected || el.children.length < 2)
    return false;
...
function CostLine({ sessionId, ctx }) {
  ...
  return /* @__PURE__ */ jsx_runtime4.jsx("span", {
    ...
    children: /* @__PURE__ */ jsx_runtime4.jsxs("span", {
      title,
...
function StarterCard({
  ...
  const [starter, setStarter] = import_react4.useState(null);
  const [note, setNote] = import_react4.useState("");
  import_react4.useEffect(() => {
    let live = true;
  ...
  return /* @__PURE__ */ jsx_runtime4.jsx("div", {
    ...
    children: /* @__PURE__ */ jsx_runtime4.jsxs("div", {
      ...
      children: [
        opener === "" || busy ? /* @__PURE__ */ jsx_runtime4.jsx("span", {
        ...
        draft === "" ? null : /* @__PURE__ */ jsx_runtime4.jsx("button", {
          type: "button",
          style: chip,
          onClick: () => save(draft),
        ...
        opener === "" ? null : /* @__PURE__ */ jsx_runtime4.jsx("button", {
          type: "button",
          style: chip,
          onClick: () => save(""),
          title: "Forget this opener",
          children: "Forget"
        })
      ]
    })
...
function StarterSlot({
  ...
  if (sessionId === undefined || inputActions === undefined)
    return null;
  return /* @__PURE__ */ jsx_runtime4.jsx(StarterCard, {
    sessionId,
    ctx,
    draft,
      ...
      return /* @__PURE__ */ jsx_runtime4.jsxs("div", {
        ...
        children: [
          /* @__PURE__ */ jsx_runtime4.jsxs("div", {
            ...
            children: [
              /* @__PURE__ */ jsx_runtime4.jsx(Spark, {
                size: 12
              }),
              /* @__PURE__ */ jsx_runtime4.jsx("span", {
                style: {
          ...
          open ? /* @__PURE__ */ jsx_runtime4.jsx("div", {
            ...
            children: it.pending ? /* @__PURE__ */ jsx_runtime4.jsx("div", {
              style: { color: CLAUDE_ORANGE, fontSize: 12, fontStyle: "italic" },
              children: "Claude is thinking…"
            }) : it.error ? /* @__PURE__ */ jsx_runtime4.jsx("div", {
...
function apply(ctx) {
  ...
  function Section(props) {
    ...
    const [openBoxes, setOpenBoxes] = import_react4.useState(true);
    const [openSessions, setOpenSessions] = import_react4.useState(false);
    const [error, setError] = import_react4.useState("");
    import_react4.useEffect(() => {
    ...
    return /* @__PURE__ */ jsx_runtime4.jsxs("div", {
      children: [
        ...
        boxes !== null && /* @__PURE__ */ jsx_runtime4.jsx(Card, {
          id: "dsh-oh-my-claude-sessions-card",
          title: "Archived Sessions",
          open: openSessions,
          onToggle: () => setOpenSessions((v) => !v),
          children: /* @__PURE__ */ jsx_runtime4.jsx(Sessions, {
            ctx,
            boxes,
            close: props.close
          })
        }),
        boxes !== null && /* @__PURE__ */ jsx_runtime4.jsx(Boxes, {
          boxes,
          setBoxes,
          open: openBoxes,
  ...
  ctx.slots.inject("conversation.composer.dock", () => {
    ctx.slots.register({ name: "conversation.composer.dock", id: "claude-cost", order: 10 }, (props) => props.sessionId ? /* @__PURE__ */ jsx_runtime4.jsx(CostLine, {
  ...
  ctx.slots.inject("conversation.input.dock", () => {
    ctx.slots.register({ name: "conversation.input.dock", id: "claude-aside", order: 45 }, (props) => props.sessionId ? /* @__PURE__ */ jsx_runtime4.jsx(AsideBubble, {
      sessionId: props.sessionId,
      ctx
    }) : null);
    ctx.slots.register({ name: "conversation.input.dock", id: "claude-starter", order: 44 }, (props) => /* @__PURE__ */ jsx_runtime4.jsx(StarterSlot, {
      ...props,
      ctx
    }));
    ctx.slots.register({ name: "conversation.input.dock", id: "claude-tool-icons", order: 46 }, () => /* @__PURE__ */ jsx_runtime4.jsx(ToolIconSprites, {}));
    return null;
  });
  ctx.slots.inject("conversation.session.header.actions", () => {
    ctx.slots.register({ name: "conversation.session.header.actions", id: "claude-idle-warn", order: 31 }, (props) => props.sessionId ? /* @__PURE__ */ jsx_runtime4.jsx(IdleChip, {
      sessionId: props.sessionId
    }) : null);
    return null;
  });
  ctx.slots.inject("conversation.input.left", () => {
    ctx.slots.register({ name: "conversation.input.left", id: "claude-access", order: 40 }, (props) => props.sessionId ? /* @__PURE__ */ jsx_runtime4.jsx(AccessShield, {
      sessionId: props.sessionId,
      ctx
    }) : null);
    ctx.slots.register({ name: "conversation.input.left", id: "oh-my-claude", order: 50 }, (props) => props.sessionId ? /* @__PURE__ */ jsx_runtime4.jsx(OhMyClaudeControl, {
      sessionId: props.sessionId,
      ctx
    }) : null);
    return null;
