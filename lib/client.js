...
function Boxes({ boxes, setBoxes, open, onToggle }) {
  ...
  const [wsDraft, setWsDraft] = import_react5.useState({ name: "", host: "", remoteCwd: "" });
  ...
  const addRw = (ev) => {
    ...
    if (!wsDraft.name.trim() || !host || !wsDraft.remoteCwd.trim())
      return;
    setBusy(true);
    setError("");
    fetch(`${ROUTE}/remote-workspaces`, {
      ...
      /* @__PURE__ */ jsx_runtime5.jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx_runtime5.jsx("p", {
            ...
            children: "Pin a directory on an SSH box as a workspace. It shows in the left sidebar like any workspace; pick the box's Claude in the model picker and the session runs in that remote folder. No files are copied; the box's Claude reads them there."
          }),
          ...
          ssh.length === 0 ? /* @__PURE__ */ jsx_runtime5.jsx("p", {
            style: { ...meta, whiteSpace: "normal", marginTop: 4 },
            children: "Add an SSH box above first, then pin a folder on it here."
          }) : /* @__PURE__ */ jsx_runtime5.jsxs("form", {
            onSubmit: addRw,
            ...
            children: [
              /* @__PURE__ */ jsx_runtime5.jsx("select", {
                ...
                children: ssh.map((b) => /* @__PURE__ */ jsx_runtime5.jsx("option", {
                  value: b.host,
                  children: b.name
                }, b.host))
              }),
