...
export const rawRowsLog = (version = 3) => ({
    ...
    rows: [
        ...
        ev(5, "tool/result", { turn: 1, step: 1, message: toolResultMessage(version, "raw", "r", "ok") }, { sourceEventSeqs: [4], surfaceOp: "append" }),
 ...
 */
export async function loadSessionCatalog(entry) {
