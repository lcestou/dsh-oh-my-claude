...
export const Config = z.object({
    ...
    toolsInline: z
        .boolean()
        .description("Render tool calls as inline text (true) or as dsh's native tool rows (false). Unset: rows on dsh 0.1.7 and later, where the text streams live between the cards and the rows survive a reload; inline before that. The Tune switch overrides this per box."),
    hookRows: z
        .boolean()
        .default(true)
