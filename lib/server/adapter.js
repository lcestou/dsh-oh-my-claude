...
import { CLAUDE_HOME, resolveClaudeHome, STATE_DIR, stateDir, auxCwd, authHeaders, loadStarted, markBusy, rememberStarted, takeInterrupted, trace, } from "./state.js";
...
export class Translator {
    ...
    callInputs = new Map();
    constructor({ toolActivity = true, toolTextLimit = TOOL_TEXT_LIMIT, relay = false, dshIds, relayed, log, onToolCall, onToolResult, onResult, } = {}) {
        this.log = log ?? (() => { });
