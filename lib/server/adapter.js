...
export class ClaudeCodeAdapter extends LlmAdapter {
    ...
    spawner() {
        ...
        const local = !this.config.configDir
            ? base
    ...
    async *turn(options, forceFresh) {
        ...
        const tr = new Translator({
            ...
            onToolCall: turnStep && this.config.toolActivity && !this.config.toolsInline
            ...
            onToolResult: turnStep && this.config.toolActivity && !this.config.toolsInline
