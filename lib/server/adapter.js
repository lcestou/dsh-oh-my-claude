...
import { ClaudeProcess, allowResult, answersFor, controlErrorLine, controlResponseLine, denyResult, parseQuestions, permissionReason, userTurnLine, interruptLine, controlRequestLine, decodeRewindResult, toJsonValue, nodeSpawner, seamSpawner, attachKeeper, launchKeeper, lazyHandle, pidAlive, readKeeperInfo, readKeeperSpec, spawnKeeper, } from "./process.js";
...
export class ClaudeCodeAdapter extends LlmAdapter {
    ...
    async setPermissionMode(sessionId, mode) {
        ...
        const reply = await this.control(proc, { subtype: "set_permission_mode", mode: info.mode });
