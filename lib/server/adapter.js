...
import { authHeaders, auxCwd, buildRedactor, CLAUDE_HOME, hasPendingNotice, loadAsides, saveAsides, loadStarters, saveStarter, loadStarted, isPermissionMode, loadPermissionModes, loadToolMode, saveToolMode, lastSelectedProvider, loadLimitWaits, loadTurnRecords, saveLimitWait, markBusy, modesUpTo, noteBoot, PERMISSION_MODES, loadCommandCatalog, rememberStarted, resolveClaudeHome, saveCommandCatalog, savePermissionMode, saveTurnRecords, STATE_DIR, stateDir, takeInterrupted, trace, loadWatches, saveWatch, loadTerminalSync, saveTerminalSync, } from "./state.js";
...
export class ClaudeCodeAdapter extends LlmAdapter {
    ...
    noteTurnLogin(sessionId, result) {
        ...
        for (const mount of ClaudeCodeAdapter.mounts(this))
            if ((mount.config.sshHost || undefined) === host)
