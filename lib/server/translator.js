...
export class Translator {
    ...
    constructor({ toolActivity = true, continueAfterLimit = false, toolTextLimit = TOOL_TEXT_LIMIT, relay = false, dshIds, relayed, log, onToolCall, onToolResult, onResult, redact, onInit, } = {}) {
        this.log = log ?? (() => { });
