 ...
 * renders in whatever the user's emoji font decides. A path renders the same everywhere.
 *
 ...
 */
import { CLAUDE_ORANGE } from "./shared.js";
...
export function sparkNode(size = 14, color = CLAUDE_ORANGE): SVGSVGElement {
