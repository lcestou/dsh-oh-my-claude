...
export function stargazerCount(text: string): number | undefined {
  ...
  let body: { stargazers_count?: unknown };
  try {
...
const cache = new Map<string, { at: number; ttl: number; value: number | undefined }>();
