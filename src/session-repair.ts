...
export type Block = { type: string; id?: string; [key: string]: unknown };
...
export type Header = { version?: number; [key: string]: unknown };
...
export const headless = (rows: Row[]): boolean => {
...
export function knownRefusal(message: string): boolean {
...
export function readLog(file: string): { header: Header; rows: Row[] } {
...
export const frame = (text: string): Buffer => zstdCompressSync(Buffer.from(text, "utf8"));
...
export function writeLog(file: string, header: Header, rows: Row[]): string {
...
export function restoreBak(file: string, bak: string): void {
  try {
...
export function migrate(catalog: Catalog, header: Header, rows: Row[]): string | undefined {
  try {
